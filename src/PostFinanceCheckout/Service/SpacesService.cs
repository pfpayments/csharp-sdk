...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class SpacesService : ISpacesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SpaceListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<SpaceListResponse> GetSpacesWithHttpInfo(long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Space</returns>
        public PostFinanceCheckout.Client.ApiResponse<Space> GetSpacesIdWithHttpInfo(long id, List<string>? expand = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SpaceSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<SpaceSearchResponse> GetSpacesSearchWithHttpInfo(List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Space</returns>
        public PostFinanceCheckout.Client.ApiResponse<Space> PatchSpacesIdWithHttpInfo(long id, SpaceUpdate spaceUpdate, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Space</returns>
        public PostFinanceCheckout.Client.ApiResponse<Space> PostSpacesWithHttpInfo(SpaceCreate spaceCreate, List<string>? expand = default, int operationIndex = 0)
        {

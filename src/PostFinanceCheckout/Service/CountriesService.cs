...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class CountriesService : ICountriesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CountryListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<CountryListResponse> GetCountriesWithHttpInfo(List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RestCountry</returns>
        public PostFinanceCheckout.Client.ApiResponse<RestCountry> GetCountriesCodeWithHttpInfo(string code, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CountrySearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<CountrySearchResponse> GetCountriesSearchWithHttpInfo(List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();

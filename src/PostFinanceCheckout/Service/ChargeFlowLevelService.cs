...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class ChargeFlowLevelService : IChargeFlowLevelService
    {
        ...
        /// <returns></returns>
        public ChargeFlowLevelService(PostFinanceCheckout.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< ChargeFlowLevel > ReadWithHttpInfo (long? spaceId, long? id)
        {
            ...
            return new ApiResponse<ChargeFlowLevel>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (ChargeFlowLevel) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ChargeFlowLevel)));
        }
        /// <summary>
        ...
        public ApiResponse< List<ChargeFlowLevel> > SearchWithHttpInfo (long? spaceId, EntityQuery query)
        {
            ...
            return new ApiResponse<List<ChargeFlowLevel>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<ChargeFlowLevel>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<ChargeFlowLevel>)));
        }
        /// <summary>

...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class PaymentProcessorService : IPaymentProcessorService
    {
        ...
        /// <returns></returns>
        public PaymentProcessorService(PostFinanceCheckout.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< List<PaymentProcessor> > AllWithHttpInfo ()
        {
            ...
            return new ApiResponse<List<PaymentProcessor>>(localVarStatusCode,
                    ...
                    (List<PaymentProcessor>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<PaymentProcessor>)));
        }
        /// <summary>
        ...
        public ApiResponse< PaymentProcessor > ReadWithHttpInfo (long? id)
        {
            ...
            return new ApiResponse<PaymentProcessor>(localVarStatusCode,
                    localVarResponse.Headers
                        .GroupBy(x => x.Name, x => x.Value.ToString())
                        .ToDictionary(x => x.Key,  x => String.Join(", ", x)),
                    (PaymentProcessor) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(PaymentProcessor)));
        }
    }
}

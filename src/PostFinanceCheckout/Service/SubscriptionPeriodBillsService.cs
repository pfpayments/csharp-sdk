...
namespace PostFinanceCheckout.Service
{
    ...
    /// </summary>
    public interface ISubscriptionPeriodBillsServiceSync : IApiAccessor
    {
        ...
        /// <param name="createNextPeriod"></param>
        /// <param name="space">Specifies the ID of the space the operation should be executed in.</param>
        /// <param name="expand"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>SubscriptionPeriodBill</returns>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISubscriptionPeriodBillsService : ISubscriptionPeriodBillsServiceSync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SubscriptionPeriodBillsService : ISubscriptionPeriodBillsService
    {

        private PostFinanceCheckout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionPeriodBillsService"/> class
        /// using Configuration object
        /// </summary>
        /// <param name="configuration">An instance of Configuration</param>
        /// <returns></returns>
        public SubscriptionPeriodBillsService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public SubscriptionPeriodBillsService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SubscriptionPeriodBillListResponse> localVarResponse = GetSubscriptionsPeriodBillsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionPeriodBillListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionPeriodBillListResponse> GetSubscriptionsPeriodBillsWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SubscriptionPeriodBillsService.GetSubscriptionsPeriodBills";
            ...
            {
                Exception _exception = this.ExceptionFactory("GetSubscriptionsPeriodBills", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SubscriptionPeriodBill> localVarResponse = GetSubscriptionsPeriodBillsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionPeriodBill</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionPeriodBill> GetSubscriptionsPeriodBillsIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "SubscriptionPeriodBillsService.GetSubscriptionsPeriodBillsId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetSubscriptionsPeriodBillsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SubscriptionPeriodBillSearchResponse> localVarResponse = GetSubscriptionsPeriodBillsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionPeriodBillSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionPeriodBillSearchResponse> GetSubscriptionsPeriodBillsSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "SubscriptionPeriodBillsService.GetSubscriptionsPeriodBillsSearch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetSubscriptionsPeriodBillsSearch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SubscriptionPeriodBill> localVarResponse = PostSubscriptionsPeriodBillsIdCloseWithHttpInfo(id, currentDate, createNextPeriod, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionPeriodBill</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionPeriodBill> PostSubscriptionsPeriodBillsIdCloseWithHttpInfo(long id, DateTime currentDate, bool createNextPeriod, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.PathParameters.Add("id", PostFinanceCheckout.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.QueryParameters.Add(PostFinanceCheckout.Client.ClientUtils.ParameterToMultiMap("", "currentDate", currentDate));
            localVarRequestOptions.QueryParameters.Add(PostFinanceCheckout.Client.ClientUtils.ParameterToMultiMap("", "createNextPeriod", createNextPeriod));
            if (expand != null)
            {
                localVarRequestOptions.QueryParameters.Add(PostFinanceCheckout.Client.ClientUtils.ParameterToMultiMap("multi", "expand", expand));
            }
            ...
            localVarRequestOptions.Operation = "SubscriptionPeriodBillsService.PostSubscriptionsPeriodBillsIdClose";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostSubscriptionsPeriodBillsIdClose", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

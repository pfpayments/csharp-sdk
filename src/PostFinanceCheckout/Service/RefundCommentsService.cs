...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class RefundCommentsService : IRefundCommentsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RefundCommentListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<RefundCommentListResponse> GetPaymentRefundsRefundIdCommentsWithHttpInfo(long refundId, long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RefundComment</returns>
        public PostFinanceCheckout.Client.ApiResponse<RefundComment> GetPaymentRefundsRefundIdCommentsIdWithHttpInfo(long refundId, long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RefundCommentSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<RefundCommentSearchResponse> GetPaymentRefundsRefundIdCommentsSearchWithHttpInfo(long refundId, long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RefundComment</returns>
        public PostFinanceCheckout.Client.ApiResponse<RefundComment> PatchPaymentRefundsRefundIdCommentsIdWithHttpInfo(long refundId, long id, long space, RefundCommentActive refundCommentActive, List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RefundComment</returns>
        public PostFinanceCheckout.Client.ApiResponse<RefundComment> PostPaymentRefundsRefundIdCommentsWithHttpInfo(long refundId, long space, RefundCommentCreate refundCommentCreate, List<string>? expand = default, int operationIndex = 0)
        {

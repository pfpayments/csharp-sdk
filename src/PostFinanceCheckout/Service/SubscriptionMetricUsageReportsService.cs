...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class SubscriptionMetricUsageReportsService : ISubscriptionMetricUsageReportsService
    {
        ...
        /// <returns></returns>
        public SubscriptionMetricUsageReportsService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public SubscriptionMetricUsageReportsService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<MetricUsageReportListResponse> localVarResponse = GetSubscriptionsMetricUsageReportsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MetricUsageReportListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<MetricUsageReportListResponse> GetSubscriptionsMetricUsageReportsWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SubscriptionMetricUsageReport> localVarResponse = GetSubscriptionsMetricUsageReportsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetricUsageReport</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionMetricUsageReport> GetSubscriptionsMetricUsageReportsIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<MetricUsageReportSearchResponse> localVarResponse = GetSubscriptionsMetricUsageReportsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MetricUsageReportSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<MetricUsageReportSearchResponse> GetSubscriptionsMetricUsageReportsSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SubscriptionMetricUsageReport> localVarResponse = PostSubscriptionsMetricUsageReportsWithHttpInfo(space, subscriptionMetricUsageReportCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetricUsageReport</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionMetricUsageReport> PostSubscriptionsMetricUsageReportsWithHttpInfo(long space, SubscriptionMetricUsageReportCreate subscriptionMetricUsageReportCreate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'subscriptionMetricUsageReportCreate' is set
            if (subscriptionMetricUsageReportCreate == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'subscriptionMetricUsageReportCreate' when calling SubscriptionMetricUsageReportsService->PostSubscriptionsMetricUsageReports");
            }

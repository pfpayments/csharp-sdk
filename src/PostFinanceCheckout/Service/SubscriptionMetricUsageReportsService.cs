...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class SubscriptionMetricUsageReportsService : ISubscriptionMetricUsageReportsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MetricUsageReportListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<MetricUsageReportListResponse> GetSubscriptionsMetricUsageReportsWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetricUsageReport</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionMetricUsageReport> GetSubscriptionsMetricUsageReportsIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetricUsageReport</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionMetricUsageReport> PostSubscriptionsMetricUsageReportsWithHttpInfo(long space, SubscriptionMetricUsageReportCreate subscriptionMetricUsageReportCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {

...
namespace PostFinanceCheckout.Service
{
    ...
    /// </summary>
    public interface IDeliveryIndicationsServiceSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDeliveryIndicationsService : IDeliveryIndicationsServiceSync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DeliveryIndicationsService : IDeliveryIndicationsService
    {

        private PostFinanceCheckout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DeliveryIndicationsService"/> class
        /// using Configuration object
        /// </summary>
        /// <param name="configuration">An instance of Configuration</param>
        /// <returns></returns>
        public DeliveryIndicationsService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public DeliveryIndicationsService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<DeliveryIndicationListResponse> localVarResponse = GetPaymentDeliveryIndicationsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeliveryIndicationListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<DeliveryIndicationListResponse> GetPaymentDeliveryIndicationsWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "DeliveryIndicationsService.GetPaymentDeliveryIndications";
            ...
            {
                Exception _exception = this.ExceptionFactory("GetPaymentDeliveryIndications", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<DeliveryIndication> localVarResponse = GetPaymentDeliveryIndicationsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeliveryIndication</returns>
        public PostFinanceCheckout.Client.ApiResponse<DeliveryIndication> GetPaymentDeliveryIndicationsIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "DeliveryIndicationsService.GetPaymentDeliveryIndicationsId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetPaymentDeliveryIndicationsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<DeliveryIndicationSearchResponse> localVarResponse = GetPaymentDeliveryIndicationsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeliveryIndicationSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<DeliveryIndicationSearchResponse> GetPaymentDeliveryIndicationsSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "DeliveryIndicationsService.GetPaymentDeliveryIndicationsSearch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetPaymentDeliveryIndicationsSearch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<DeliveryIndication> localVarResponse = PostPaymentDeliveryIndicationsIdMarkNotSuitableWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeliveryIndication</returns>
        public PostFinanceCheckout.Client.ApiResponse<DeliveryIndication> PostPaymentDeliveryIndicationsIdMarkNotSuitableWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "DeliveryIndicationsService.PostPaymentDeliveryIndicationsIdMarkNotSuitable";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostPaymentDeliveryIndicationsIdMarkNotSuitable", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<DeliveryIndication> localVarResponse = PostPaymentDeliveryIndicationsIdMarkSuitableWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeliveryIndication</returns>
        public PostFinanceCheckout.Client.ApiResponse<DeliveryIndication> PostPaymentDeliveryIndicationsIdMarkSuitableWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "DeliveryIndicationsService.PostPaymentDeliveryIndicationsIdMarkSuitable";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostPaymentDeliveryIndicationsIdMarkSuitable", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class SubscriptionProductMeteredFeesService : ISubscriptionProductMeteredFeesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductMeteredFee</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductMeteredFee> GetSubscriptionsProductsMeteredFeesIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductMeteredFeeSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductMeteredFeeSearchResponse> GetSubscriptionsProductsMeteredFeesSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductMeteredFee</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductMeteredFee> PatchSubscriptionsProductsMeteredFeesIdWithHttpInfo(long id, long space, ProductMeteredFeeUpdate productMeteredFeeUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductMeteredFee</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductMeteredFee> PostSubscriptionsProductsMeteredFeesWithHttpInfo(long space, ProductMeteredFeeUpdate productMeteredFeeUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'productMeteredFeeUpdate' is set
            if (productMeteredFeeUpdate == null)
            {

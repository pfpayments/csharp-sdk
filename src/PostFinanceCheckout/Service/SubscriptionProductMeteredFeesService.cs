...
namespace PostFinanceCheckout.Service
{
    ...
    /// </summary>
    public interface ISubscriptionProductMeteredFeesServiceSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteSubscriptionsProductsMeteredFeesId(long id, long space, int operationIndex = 0);
        ...
        /// <param name="id"></param>
        /// <param name="space">Specifies the ID of the space the operation should be executed in.</param>
        /// <param name="productMeteredFeeUpdate"></param>
        /// <param name="expand"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ProductMeteredFee</returns>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISubscriptionProductMeteredFeesService : ISubscriptionProductMeteredFeesServiceSync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SubscriptionProductMeteredFeesService : ISubscriptionProductMeteredFeesService
    {

        private PostFinanceCheckout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionProductMeteredFeesService"/> class
        /// using Configuration object
        /// </summary>
        /// <param name="configuration">An instance of Configuration</param>
        /// <returns></returns>
        public SubscriptionProductMeteredFeesService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public SubscriptionProductMeteredFeesService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteSubscriptionsProductsMeteredFeesId(long id, long space, int operationIndex = 0)
        {
            DeleteSubscriptionsProductsMeteredFeesIdWithHttpInfo(id, space);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PostFinanceCheckout.Client.ApiResponse<Object> DeleteSubscriptionsProductsMeteredFeesIdWithHttpInfo(long id, long space, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SubscriptionProductMeteredFeesService.DeleteSubscriptionsProductsMeteredFeesId";
            ...
            {
                Exception _exception = this.ExceptionFactory("DeleteSubscriptionsProductsMeteredFeesId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<ProductMeteredFeeListResponse> localVarResponse = GetSubscriptionsProductsMeteredFeesWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductMeteredFeeListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductMeteredFeeListResponse> GetSubscriptionsProductsMeteredFeesWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "SubscriptionProductMeteredFeesService.GetSubscriptionsProductsMeteredFees";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetSubscriptionsProductsMeteredFees", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<ProductMeteredFee> localVarResponse = GetSubscriptionsProductsMeteredFeesIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductMeteredFee</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductMeteredFee> GetSubscriptionsProductsMeteredFeesIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "SubscriptionProductMeteredFeesService.GetSubscriptionsProductsMeteredFeesId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetSubscriptionsProductsMeteredFeesId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<ProductMeteredFeeSearchResponse> localVarResponse = GetSubscriptionsProductsMeteredFeesSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductMeteredFeeSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductMeteredFeeSearchResponse> GetSubscriptionsProductsMeteredFeesSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "SubscriptionProductMeteredFeesService.GetSubscriptionsProductsMeteredFeesSearch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetSubscriptionsProductsMeteredFeesSearch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<ProductMeteredFee> localVarResponse = PatchSubscriptionsProductsMeteredFeesIdWithHttpInfo(id, space, productMeteredFeeUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductMeteredFee</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductMeteredFee> PatchSubscriptionsProductsMeteredFeesIdWithHttpInfo(long id, long space, ProductMeteredFeeUpdate productMeteredFeeUpdate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'productMeteredFeeUpdate' is set
            if (productMeteredFeeUpdate == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'productMeteredFeeUpdate' when calling SubscriptionProductMeteredFeesService->PatchSubscriptionsProductsMeteredFeesId");
            }
            ...
            localVarRequestOptions.HeaderParameters.Add("Space", PostFinanceCheckout.Client.ClientUtils.ParameterToString(space)); // header parameter
            localVarRequestOptions.Data = productMeteredFeeUpdate;

            localVarRequestOptions.Operation = "SubscriptionProductMeteredFeesService.PatchSubscriptionsProductsMeteredFeesId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PatchSubscriptionsProductsMeteredFeesId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<ProductMeteredFee> localVarResponse = PostSubscriptionsProductsMeteredFeesWithHttpInfo(space, productMeteredFeeUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductMeteredFee</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductMeteredFee> PostSubscriptionsProductsMeteredFeesWithHttpInfo(long space, ProductMeteredFeeUpdate productMeteredFeeUpdate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'productMeteredFeeUpdate' is set
            if (productMeteredFeeUpdate == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'productMeteredFeeUpdate' when calling SubscriptionProductMeteredFeesService->PostSubscriptionsProductsMeteredFees");
            }
            ...
            localVarRequestOptions.Operation = "SubscriptionProductMeteredFeesService.PostSubscriptionsProductsMeteredFees";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostSubscriptionsProductsMeteredFees", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

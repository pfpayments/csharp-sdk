...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class HumanUsersRolesService : IHumanUsersRolesService
    {
        ...
        /// <returns></returns>
        public HumanUsersRolesService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public HumanUsersRolesService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PostFinanceCheckout.Client.ApiResponse<Object> DeleteHumanUsersUserIdAccountRolesWithHttpInfo(long userId, long roleId, long account, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PostFinanceCheckout.Client.ApiResponse<Object> DeleteHumanUsersUserIdSpaceRolesWithHttpInfo(long userId, long roleId, long space, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<UserAccountRoleListResponse> localVarResponse = GetHumanUsersUserIdAccountRolesWithHttpInfo(userId, account);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserAccountRoleListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<UserAccountRoleListResponse> GetHumanUsersUserIdAccountRolesWithHttpInfo(long userId, long account, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<UserSpaceRoleListResponse> localVarResponse = GetHumanUsersUserIdSpaceRolesWithHttpInfo(userId, space);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserSpaceRoleListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<UserSpaceRoleListResponse> GetHumanUsersUserIdSpaceRolesWithHttpInfo(long userId, long space, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<UserAccountRole> localVarResponse = PostHumanUsersUserIdAccountRolesWithHttpInfo(userId, roleId, account, appliesOnSubAccount);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserAccountRole</returns>
        public PostFinanceCheckout.Client.ApiResponse<UserAccountRole> PostHumanUsersUserIdAccountRolesWithHttpInfo(long userId, long roleId, long account, bool? appliesOnSubAccount = default(bool?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<UserSpaceRole> localVarResponse = PostHumanUsersUserIdSpaceRolesWithHttpInfo(userId, roleId, space);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserSpaceRole</returns>
        public PostFinanceCheckout.Client.ApiResponse<UserSpaceRole> PostHumanUsersUserIdSpaceRolesWithHttpInfo(long userId, long roleId, long space, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();

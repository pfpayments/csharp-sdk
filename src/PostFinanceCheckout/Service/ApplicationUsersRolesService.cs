...
namespace PostFinanceCheckout.Service
{
    ...
    public interface IApplicationUsersRolesServiceSync : IApiAccessor
    {
        ...
        UserAccountRole PostApplicationUsersUserIdAccountRoles(long userId, long roleId, long account, bool? appliesOnSubAccount = default, int operationIndex = 0);
        ...
        ApiResponse<UserAccountRole> PostApplicationUsersUserIdAccountRolesWithHttpInfo(long userId, long roleId, long account, bool? appliesOnSubAccount = default, int operationIndex = 0);
        /// <summary>
    ...
    public partial class ApplicationUsersRolesService : IApplicationUsersRolesService
    {
        ...
        /// <returns></returns>
        public ApplicationUsersRolesService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public ApplicationUsersRolesService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PostFinanceCheckout.Client.ApiResponse<Object> DeleteApplicationUsersUserIdAccountRolesWithHttpInfo(long userId, long roleId, long account, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Delete<Object>("/application-users/{userId}/account-roles",
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PostFinanceCheckout.Client.ApiResponse<Object> DeleteApplicationUsersUserIdSpaceRolesWithHttpInfo(long userId, long roleId, long space, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<Object>("/application-users/{userId}/space-roles",
                localVarRequestOptions, requestTimeout, Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<UserAccountRoleListResponse> localVarResponse = GetApplicationUsersUserIdAccountRolesWithHttpInfo(userId, account);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserAccountRoleListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<UserAccountRoleListResponse> GetApplicationUsersUserIdAccountRolesWithHttpInfo(long userId, long account, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<UserAccountRoleListResponse>("/application-users/{userId}/account-roles",
                localVarRequestOptions, requestTimeout, Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<UserSpaceRoleListResponse> localVarResponse = GetApplicationUsersUserIdSpaceRolesWithHttpInfo(userId, space);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserSpaceRoleListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<UserSpaceRoleListResponse> GetApplicationUsersUserIdSpaceRolesWithHttpInfo(long userId, long space, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<UserSpaceRoleListResponse>("/application-users/{userId}/space-roles",
                localVarRequestOptions, requestTimeout, Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>UserAccountRole</returns>
        public UserAccountRole PostApplicationUsersUserIdAccountRoles(long userId, long roleId, long account, bool? appliesOnSubAccount = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.ApiResponse<UserAccountRole> localVarResponse = PostApplicationUsersUserIdAccountRolesWithHttpInfo(userId, roleId, account, appliesOnSubAccount);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserAccountRole</returns>
        public PostFinanceCheckout.Client.ApiResponse<UserAccountRole> PostApplicationUsersUserIdAccountRolesWithHttpInfo(long userId, long roleId, long account, bool? appliesOnSubAccount = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<UserAccountRole>("/application-users/{userId}/account-roles",
                localVarRequestOptions, requestTimeout, Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<UserSpaceRole> localVarResponse = PostApplicationUsersUserIdSpaceRolesWithHttpInfo(userId, roleId, space);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserSpaceRole</returns>
        public PostFinanceCheckout.Client.ApiResponse<UserSpaceRole> PostApplicationUsersUserIdSpaceRolesWithHttpInfo(long userId, long roleId, long space, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<UserSpaceRole>("/application-users/{userId}/space-roles",
                localVarRequestOptions, requestTimeout, Configuration);
            if (this.ExceptionFactory != null)
            {

...
namespace PostFinanceCheckout.Service
{
    ...
    /// </summary>
    public interface ITransactionLineItemVersionsServiceSync : IApiAccessor
    {
        ...
        /// <exception cref="PostFinanceCheckout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="space">Specifies the ID of the space the operation should be executed in.</param>
        /// <param name="transactionLineItemVersionCreate"></param>
        /// <param name="expand"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TransactionLineItemVersion</returns>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITransactionLineItemVersionsService : ITransactionLineItemVersionsServiceSync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class TransactionLineItemVersionsService : ITransactionLineItemVersionsService
    {

        private PostFinanceCheckout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionLineItemVersionsService"/> class
        /// using Configuration object
        /// </summary>
        /// <param name="configuration">An instance of Configuration</param>
        /// <returns></returns>
        public TransactionLineItemVersionsService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public TransactionLineItemVersionsService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<LineItemVersionListResponse> localVarResponse = GetPaymentTransactionsLineItemVersionsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LineItemVersionListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<LineItemVersionListResponse> GetPaymentTransactionsLineItemVersionsWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "TransactionLineItemVersionsService.GetPaymentTransactionsLineItemVersions";
            ...
            {
                Exception _exception = this.ExceptionFactory("GetPaymentTransactionsLineItemVersions", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<TransactionLineItemVersion> localVarResponse = GetPaymentTransactionsLineItemVersionsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionLineItemVersion</returns>
        public PostFinanceCheckout.Client.ApiResponse<TransactionLineItemVersion> GetPaymentTransactionsLineItemVersionsIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "TransactionLineItemVersionsService.GetPaymentTransactionsLineItemVersionsId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetPaymentTransactionsLineItemVersionsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<LineItemVersionSearchResponse> localVarResponse = GetPaymentTransactionsLineItemVersionsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LineItemVersionSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<LineItemVersionSearchResponse> GetPaymentTransactionsLineItemVersionsSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "TransactionLineItemVersionsService.GetPaymentTransactionsLineItemVersionsSearch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetPaymentTransactionsLineItemVersionsSearch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<TransactionLineItemVersion> localVarResponse = PostPaymentTransactionsLineItemVersionsWithHttpInfo(space, transactionLineItemVersionCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionLineItemVersion</returns>
        public PostFinanceCheckout.Client.ApiResponse<TransactionLineItemVersion> PostPaymentTransactionsLineItemVersionsWithHttpInfo(long space, TransactionLineItemVersionCreate transactionLineItemVersionCreate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'transactionLineItemVersionCreate' is set
            if (transactionLineItemVersionCreate == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'transactionLineItemVersionCreate' when calling TransactionLineItemVersionsService->PostPaymentTransactionsLineItemVersions");
            }
            ...
            localVarRequestOptions.HeaderParameters.Add("Space", PostFinanceCheckout.Client.ClientUtils.ParameterToString(space)); // header parameter
            localVarRequestOptions.Data = transactionLineItemVersionCreate;

            localVarRequestOptions.Operation = "TransactionLineItemVersionsService.PostPaymentTransactionsLineItemVersions";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostPaymentTransactionsLineItemVersions", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

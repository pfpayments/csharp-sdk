...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class CustomerCommentsService : ICustomerCommentsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerCommentListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<CustomerCommentListResponse> GetCustomersCustomerIdCommentsWithHttpInfo(long customerId, long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerComment</returns>
        public PostFinanceCheckout.Client.ApiResponse<CustomerComment> GetCustomersCustomerIdCommentsIdWithHttpInfo(long customerId, long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerCommentSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<CustomerCommentSearchResponse> GetCustomersCustomerIdCommentsSearchWithHttpInfo(long customerId, long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerComment</returns>
        public PostFinanceCheckout.Client.ApiResponse<CustomerComment> PatchCustomersCustomerIdCommentsIdWithHttpInfo(long customerId, long id, long space, CustomerCommentActive customerCommentActive, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerComment</returns>
        public PostFinanceCheckout.Client.ApiResponse<CustomerComment> PostCustomersCustomerIdCommentsWithHttpInfo(long customerId, long space, CustomerCommentCreate customerCommentCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {

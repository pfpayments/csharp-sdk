...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class SingleSignOnUsersService : ISingleSignOnUsersService
    {
        ...
        /// <returns></returns>
        public SingleSignOnUsersService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public SingleSignOnUsersService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PostFinanceCheckout.Client.ApiResponse<Object> DeleteSingleSignOnUsersIdWithHttpInfo(long id, int operationIndex = 0)
        {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SingleSignOnUserListResponse> localVarResponse = GetSingleSignOnUsersWithHttpInfo(after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUserListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<SingleSignOnUserListResponse> GetSingleSignOnUsersWithHttpInfo(long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SingleSignOnUser> localVarResponse = GetSingleSignOnUsersIdWithHttpInfo(id, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUser</returns>
        public PostFinanceCheckout.Client.ApiResponse<SingleSignOnUser> GetSingleSignOnUsersIdWithHttpInfo(long id, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SingleSignOnUserSearchResponse> localVarResponse = GetSingleSignOnUsersSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUserSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<SingleSignOnUserSearchResponse> GetSingleSignOnUsersSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SingleSignOnUser> localVarResponse = PatchSingleSignOnUsersIdWithHttpInfo(id, singleSignOnUserUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUser</returns>
        public PostFinanceCheckout.Client.ApiResponse<SingleSignOnUser> PatchSingleSignOnUsersIdWithHttpInfo(long id, SingleSignOnUserUpdate singleSignOnUserUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'singleSignOnUserUpdate' is set
            if (singleSignOnUserUpdate == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'singleSignOnUserUpdate' when calling SingleSignOnUsersService->PatchSingleSignOnUsersId");
            }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SingleSignOnUser> localVarResponse = PostSingleSignOnUsersWithHttpInfo(singleSignOnUserCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SingleSignOnUser</returns>
        public PostFinanceCheckout.Client.ApiResponse<SingleSignOnUser> PostSingleSignOnUsersWithHttpInfo(SingleSignOnUserCreate singleSignOnUserCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'singleSignOnUserCreate' is set
            if (singleSignOnUserCreate == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'singleSignOnUserCreate' when calling SingleSignOnUsersService->PostSingleSignOnUsers");
            }

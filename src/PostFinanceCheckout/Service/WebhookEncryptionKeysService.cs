...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class WebhookEncryptionKeysService : IWebhookEncryptionKeysService
    {
        ...
        /// <returns></returns>
        public WebhookEncryptionKeysService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public WebhookEncryptionKeysService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<string> localVarResponse = GetWebhooksEncryptionKeysIdWithHttpInfo(id);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of string</returns>
        public PostFinanceCheckout.Client.ApiResponse<string> GetWebhooksEncryptionKeysIdWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'id' when calling WebhookEncryptionKeysService->GetWebhooksEncryptionKeysId");
            }
            ...
            /// </summary>
            /// <exception cref="PostFinanceCheckout.Client.PostFinanceCheckoutSdkException">Thrown when validation fails or public key is not found.</exception>

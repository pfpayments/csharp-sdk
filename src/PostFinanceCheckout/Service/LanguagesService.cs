...
namespace PostFinanceCheckout.Service
{
    ...
    /// </summary>
    public interface ILanguagesServiceSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RestLanguage</returns>
        RestLanguage GetLanguagesCode(string code, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ILanguagesService : ILanguagesServiceSync
    {
    ...
    public partial class LanguagesService : ILanguagesService
    {
        ...
        /// <returns></returns>
        public LanguagesService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public LanguagesService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<LanguageListResponse> localVarResponse = GetLanguagesWithHttpInfo(expand);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LanguageListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<LanguageListResponse> GetLanguagesWithHttpInfo(List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "LanguagesService.GetLanguages";
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RestLanguage</returns>
        public RestLanguage GetLanguagesCode(string code, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.ApiResponse<RestLanguage> localVarResponse = GetLanguagesCodeWithHttpInfo(code);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RestLanguage</returns>
        public PostFinanceCheckout.Client.ApiResponse<RestLanguage> GetLanguagesCodeWithHttpInfo(string code, int operationIndex = 0)
        {
            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'code' when calling LanguagesService->GetLanguagesCode");
            }
            ...
            localVarRequestOptions.Operation = "LanguagesService.GetLanguagesCode";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetLanguagesCode", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<LanguageSearchResponse> localVarResponse = GetLanguagesSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LanguageSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<LanguageSearchResponse> GetLanguagesSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "LanguagesService.GetLanguagesSearch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetLanguagesSearch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class AnalyticsQueriesService : IAnalyticsQueriesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PostFinanceCheckout.Client.ApiResponse<Object> DeleteAnalyticsQueriesQueryTokenWithHttpInfo(string queryToken, long account, int operationIndex = 0)
        {
            // verify the required parameter 'queryToken' is set
            if (queryToken == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'queryToken' when calling AnalyticsQueriesService->DeleteAnalyticsQueriesQueryToken");
            }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SubmittedAnalyticsQueryExecution> localVarResponse = GetAnalyticsQueriesQueryTokenWithHttpInfo(queryToken, account);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubmittedAnalyticsQueryExecution</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubmittedAnalyticsQueryExecution> GetAnalyticsQueriesQueryTokenWithHttpInfo(string queryToken, long account, int operationIndex = 0)
        {
            // verify the required parameter 'queryToken' is set
            if (queryToken == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'queryToken' when calling AnalyticsQueriesService->GetAnalyticsQueriesQueryToken");
            }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<string> localVarResponse = GetAnalyticsQueriesQueryTokenResultWithHttpInfo(queryToken, account);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of string</returns>
        public PostFinanceCheckout.Client.ApiResponse<string> GetAnalyticsQueriesQueryTokenResultWithHttpInfo(string queryToken, long account, int operationIndex = 0)
        {
            // verify the required parameter 'queryToken' is set
            if (queryToken == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'queryToken' when calling AnalyticsQueriesService->GetAnalyticsQueriesQueryTokenResult");
            }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<AnalyticsQueryExecutionResponse> localVarResponse = PostAnalyticsQueriesSubmitWithHttpInfo(account, analyticsQueryExecutionRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AnalyticsQueryExecutionResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<AnalyticsQueryExecutionResponse> PostAnalyticsQueriesSubmitWithHttpInfo(long account, AnalyticsQueryExecutionRequest analyticsQueryExecutionRequest, int operationIndex = 0)
        {

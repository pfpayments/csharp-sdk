...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class PaymentLinksService : IPaymentLinksService
    {
        ...
        /// <returns></returns>
        public PaymentLinksService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public PaymentLinksService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PostFinanceCheckout.Client.ApiResponse<Object> DeletePaymentLinksIdWithHttpInfo(long id, long space, int operationIndex = 0)
        {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<PaymentLinkListResponse> localVarResponse = GetPaymentLinksWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLinkListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<PaymentLinkListResponse> GetPaymentLinksWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<PaymentLink> localVarResponse = GetPaymentLinksIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLink</returns>
        public PostFinanceCheckout.Client.ApiResponse<PaymentLink> GetPaymentLinksIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<PaymentLinkSearchResponse> localVarResponse = GetPaymentLinksSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLinkSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<PaymentLinkSearchResponse> GetPaymentLinksSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<PaymentLink> localVarResponse = PatchPaymentLinksIdWithHttpInfo(id, space, paymentLinkUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLink</returns>
        public PostFinanceCheckout.Client.ApiResponse<PaymentLink> PatchPaymentLinksIdWithHttpInfo(long id, long space, PaymentLinkUpdate paymentLinkUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'paymentLinkUpdate' is set
            if (paymentLinkUpdate == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'paymentLinkUpdate' when calling PaymentLinksService->PatchPaymentLinksId");
            }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<PaymentLink> localVarResponse = PostPaymentLinksWithHttpInfo(space, paymentLinkCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentLink</returns>
        public PostFinanceCheckout.Client.ApiResponse<PaymentLink> PostPaymentLinksWithHttpInfo(long space, PaymentLinkCreate paymentLinkCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'paymentLinkCreate' is set
            if (paymentLinkCreate == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'paymentLinkCreate' when calling PaymentLinksService->PostPaymentLinks");
            }

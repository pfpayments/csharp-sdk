...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class PaymentProcessorConfigurationsService : IPaymentProcessorConfigurationsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfiguration</returns>
        public PostFinanceCheckout.Client.ApiResponse<PaymentProcessorConfiguration> GetPaymentProcessorConfigurationsIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfigurationSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<PaymentProcessorConfigurationSearchResponse> GetPaymentProcessorConfigurationsSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfiguration</returns>
        public PostFinanceCheckout.Client.ApiResponse<PaymentProcessorConfiguration> PatchPaymentProcessorConfigurationsIdWithHttpInfo(long id, long space, PaymentProcessorConfigurationActive paymentProcessorConfigurationActive, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfiguration</returns>
        public PostFinanceCheckout.Client.ApiResponse<PaymentProcessorConfiguration> PostPaymentProcessorConfigurationsWithHttpInfo(long space, PaymentProcessorConfigurationCreate paymentProcessorConfigurationCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {

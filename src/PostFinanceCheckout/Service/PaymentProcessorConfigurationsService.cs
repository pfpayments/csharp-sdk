...
namespace PostFinanceCheckout.Service
{
    ...
    /// </summary>
    public interface IPaymentProcessorConfigurationsServiceSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeletePaymentProcessorConfigurationsId(long id, long space, int operationIndex = 0);
        ...
        /// <param name="id"></param>
        /// <param name="space">Specifies the ID of the space the operation should be executed in.</param>
        /// <param name="paymentProcessorConfigurationActive"></param>
        /// <param name="expand"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>PaymentProcessorConfiguration</returns>
        ...
        /// <exception cref="PostFinanceCheckout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="space">Specifies the ID of the space the operation should be executed in.</param>
        /// <param name="paymentProcessorConfigurationCreate"></param>
        /// <param name="expand"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>PaymentProcessorConfiguration</returns>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IPaymentProcessorConfigurationsService : IPaymentProcessorConfigurationsServiceSync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class PaymentProcessorConfigurationsService : IPaymentProcessorConfigurationsService
    {

        private PostFinanceCheckout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProcessorConfigurationsService"/> class
        /// using Configuration object
        /// </summary>
        /// <param name="configuration">An instance of Configuration</param>
        /// <returns></returns>
        public PaymentProcessorConfigurationsService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public PaymentProcessorConfigurationsService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Delete a payment processor configuration Permanently deletes a payment processor configuration.
        /// </summary>
        /// <exception cref="PostFinanceCheckout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id"></param>
        /// <param name="space">Specifies the ID of the space the operation should be executed in.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeletePaymentProcessorConfigurationsId(long id, long space, int operationIndex = 0)
        {
            DeletePaymentProcessorConfigurationsIdWithHttpInfo(id, space);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PostFinanceCheckout.Client.ApiResponse<Object> DeletePaymentProcessorConfigurationsIdWithHttpInfo(long id, long space, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "PaymentProcessorConfigurationsService.DeletePaymentProcessorConfigurationsId";
            ...
            {
                Exception _exception = this.ExceptionFactory("DeletePaymentProcessorConfigurationsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<PaymentProcessorConfigurationListResponse> localVarResponse = GetPaymentProcessorConfigurationsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfigurationListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<PaymentProcessorConfigurationListResponse> GetPaymentProcessorConfigurationsWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "PaymentProcessorConfigurationsService.GetPaymentProcessorConfigurations";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetPaymentProcessorConfigurations", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<PaymentProcessorConfiguration> localVarResponse = GetPaymentProcessorConfigurationsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfiguration</returns>
        public PostFinanceCheckout.Client.ApiResponse<PaymentProcessorConfiguration> GetPaymentProcessorConfigurationsIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "PaymentProcessorConfigurationsService.GetPaymentProcessorConfigurationsId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetPaymentProcessorConfigurationsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<PaymentProcessorConfigurationSearchResponse> localVarResponse = GetPaymentProcessorConfigurationsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfigurationSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<PaymentProcessorConfigurationSearchResponse> GetPaymentProcessorConfigurationsSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "PaymentProcessorConfigurationsService.GetPaymentProcessorConfigurationsSearch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetPaymentProcessorConfigurationsSearch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<PaymentProcessorConfiguration> localVarResponse = PatchPaymentProcessorConfigurationsIdWithHttpInfo(id, space, paymentProcessorConfigurationActive, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfiguration</returns>
        public PostFinanceCheckout.Client.ApiResponse<PaymentProcessorConfiguration> PatchPaymentProcessorConfigurationsIdWithHttpInfo(long id, long space, PaymentProcessorConfigurationActive paymentProcessorConfigurationActive, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'paymentProcessorConfigurationActive' is set
            if (paymentProcessorConfigurationActive == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'paymentProcessorConfigurationActive' when calling PaymentProcessorConfigurationsService->PatchPaymentProcessorConfigurationsId");
            }
            ...
            localVarRequestOptions.HeaderParameters.Add("Space", PostFinanceCheckout.Client.ClientUtils.ParameterToString(space)); // header parameter
            localVarRequestOptions.Data = paymentProcessorConfigurationActive;

            localVarRequestOptions.Operation = "PaymentProcessorConfigurationsService.PatchPaymentProcessorConfigurationsId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PatchPaymentProcessorConfigurationsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<PaymentProcessorConfiguration> localVarResponse = PostPaymentProcessorConfigurationsWithHttpInfo(space, paymentProcessorConfigurationCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentProcessorConfiguration</returns>
        public PostFinanceCheckout.Client.ApiResponse<PaymentProcessorConfiguration> PostPaymentProcessorConfigurationsWithHttpInfo(long space, PaymentProcessorConfigurationCreate paymentProcessorConfigurationCreate, List<string>? expand = default, int operationIndex = 0)
        {
            // verify the required parameter 'paymentProcessorConfigurationCreate' is set
            if (paymentProcessorConfigurationCreate == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'paymentProcessorConfigurationCreate' when calling PaymentProcessorConfigurationsService->PostPaymentProcessorConfigurations");
            }
            ...
            localVarRequestOptions.HeaderParameters.Add("Space", PostFinanceCheckout.Client.ClientUtils.ParameterToString(space)); // header parameter
            localVarRequestOptions.Data = paymentProcessorConfigurationCreate;

            localVarRequestOptions.Operation = "PaymentProcessorConfigurationsService.PostPaymentProcessorConfigurations";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostPaymentProcessorConfigurations", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

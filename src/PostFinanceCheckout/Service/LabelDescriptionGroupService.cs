...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class LabelDescriptionGroupService : ILabelDescriptionGroupService
    {
        ...
        /// <returns></returns>
        public LabelDescriptionGroupService(PostFinanceCheckout.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< List<LabelDescriptorGroup> > AllWithHttpInfo ()
        {
            ...
            return new ApiResponse<List<LabelDescriptorGroup>>(localVarStatusCode,
                ...
                (List<LabelDescriptorGroup>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<LabelDescriptorGroup>)));
        }
        /// <summary>
        ...
        public ApiResponse< LabelDescriptorGroup > ReadWithHttpInfo (long? id)
        {
            ...
            return new ApiResponse<LabelDescriptorGroup>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (LabelDescriptorGroup) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(LabelDescriptorGroup)));
        }
    }
}

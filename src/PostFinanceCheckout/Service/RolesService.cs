...
namespace PostFinanceCheckout.Service
{
    ...
    /// </summary>
    public interface IRolesServiceSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteRolesId(long id, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IRolesService : IRolesServiceSync
    {
    ...
    public partial class RolesService : IRolesService
    {
        ...
        /// <returns></returns>
        public RolesService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public RolesService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Delete a role Permanently deletes a role. It cannot be undone.
        /// </summary>
        /// <exception cref="PostFinanceCheckout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteRolesId(long id, int operationIndex = 0)
        {
            DeleteRolesIdWithHttpInfo(id);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PostFinanceCheckout.Client.ApiResponse<Object> DeleteRolesIdWithHttpInfo(long id, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "RolesService.DeleteRolesId";
            ...
            {
                Exception _exception = this.ExceptionFactory("DeleteRolesId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<RoleListResponse> localVarResponse = GetRolesWithHttpInfo(after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RoleListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<RoleListResponse> GetRolesWithHttpInfo(long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "RolesService.GetRoles";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<Role> localVarResponse = GetRolesIdWithHttpInfo(id, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Role</returns>
        public PostFinanceCheckout.Client.ApiResponse<Role> GetRolesIdWithHttpInfo(long id, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "RolesService.GetRolesId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetRolesId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<RoleSearchResponse> localVarResponse = GetRolesSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RoleSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<RoleSearchResponse> GetRolesSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "RolesService.GetRolesSearch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetRolesSearch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<Role> localVarResponse = PatchRolesIdWithHttpInfo(id, roleUpdate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Role</returns>
        public PostFinanceCheckout.Client.ApiResponse<Role> PatchRolesIdWithHttpInfo(long id, RoleUpdate roleUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'roleUpdate' is set
            if (roleUpdate == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'roleUpdate' when calling RolesService->PatchRolesId");
            }
            ...
            localVarRequestOptions.Data = roleUpdate;

            localVarRequestOptions.Operation = "RolesService.PatchRolesId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PatchRolesId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<Role> localVarResponse = PostRolesWithHttpInfo(roleCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Role</returns>
        public PostFinanceCheckout.Client.ApiResponse<Role> PostRolesWithHttpInfo(RoleCreate roleCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'roleCreate' is set
            if (roleCreate == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'roleCreate' when calling RolesService->PostRoles");
            }
            ...
            localVarRequestOptions.Data = roleCreate;

            localVarRequestOptions.Operation = "RolesService.PostRoles";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostRoles", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class SubscriptionProductSetupFeesService : ISubscriptionProductSetupFeesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductSetupFee</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductSetupFee> GetSubscriptionsProductsSetupFeesIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductSetupFeeSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductSetupFeeSearchResponse> GetSubscriptionsProductsSetupFeesSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductSetupFee</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductSetupFee> PatchSubscriptionsProductsSetupFeesIdWithHttpInfo(long id, long space, ProductSetupFeeUpdate productSetupFeeUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductSetupFee</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductSetupFee> PostSubscriptionsProductsSetupFeesWithHttpInfo(long space, ProductSetupFeeUpdate productSetupFeeUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'productSetupFeeUpdate' is set
            if (productSetupFeeUpdate == null)
            {

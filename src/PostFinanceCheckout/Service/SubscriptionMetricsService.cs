...
namespace PostFinanceCheckout.Service
{
    ...
    /// </summary>
    public interface ISubscriptionMetricsServiceSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteSubscriptionsMetricsId(long id, long space, int operationIndex = 0);
        ...
        /// <param name="id"></param>
        /// <param name="space">Specifies the ID of the space the operation should be executed in.</param>
        /// <param name="subscriptionMetricActive"></param>
        /// <param name="expand"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>SubscriptionMetric</returns>
        ...
        /// <exception cref="PostFinanceCheckout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="space">Specifies the ID of the space the operation should be executed in.</param>
        /// <param name="subscriptionMetricCreate"></param>
        /// <param name="expand"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>SubscriptionMetric</returns>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISubscriptionMetricsService : ISubscriptionMetricsServiceSync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SubscriptionMetricsService : ISubscriptionMetricsService
    {

        private PostFinanceCheckout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionMetricsService"/> class
        /// using Configuration object
        /// </summary>
        /// <param name="configuration">An instance of Configuration</param>
        /// <returns></returns>
        public SubscriptionMetricsService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public SubscriptionMetricsService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteSubscriptionsMetricsId(long id, long space, int operationIndex = 0)
        {
            DeleteSubscriptionsMetricsIdWithHttpInfo(id, space);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PostFinanceCheckout.Client.ApiResponse<Object> DeleteSubscriptionsMetricsIdWithHttpInfo(long id, long space, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SubscriptionMetricsService.DeleteSubscriptionsMetricsId";
            ...
            {
                Exception _exception = this.ExceptionFactory("DeleteSubscriptionsMetricsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<MetricListResponse> localVarResponse = GetSubscriptionsMetricsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MetricListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<MetricListResponse> GetSubscriptionsMetricsWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "SubscriptionMetricsService.GetSubscriptionsMetrics";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetSubscriptionsMetrics", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SubscriptionMetric> localVarResponse = GetSubscriptionsMetricsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetric</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionMetric> GetSubscriptionsMetricsIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "SubscriptionMetricsService.GetSubscriptionsMetricsId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetSubscriptionsMetricsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<MetricSearchResponse> localVarResponse = GetSubscriptionsMetricsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MetricSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<MetricSearchResponse> GetSubscriptionsMetricsSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "SubscriptionMetricsService.GetSubscriptionsMetricsSearch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetSubscriptionsMetricsSearch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SubscriptionMetric> localVarResponse = PatchSubscriptionsMetricsIdWithHttpInfo(id, space, subscriptionMetricActive, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetric</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionMetric> PatchSubscriptionsMetricsIdWithHttpInfo(long id, long space, SubscriptionMetricActive subscriptionMetricActive, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'subscriptionMetricActive' is set
            if (subscriptionMetricActive == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'subscriptionMetricActive' when calling SubscriptionMetricsService->PatchSubscriptionsMetricsId");
            }
            ...
            localVarRequestOptions.HeaderParameters.Add("Space", PostFinanceCheckout.Client.ClientUtils.ParameterToString(space)); // header parameter
            localVarRequestOptions.Data = subscriptionMetricActive;

            localVarRequestOptions.Operation = "SubscriptionMetricsService.PatchSubscriptionsMetricsId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PatchSubscriptionsMetricsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SubscriptionMetric> localVarResponse = PostSubscriptionsMetricsWithHttpInfo(space, subscriptionMetricCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionMetric</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionMetric> PostSubscriptionsMetricsWithHttpInfo(long space, SubscriptionMetricCreate subscriptionMetricCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'subscriptionMetricCreate' is set
            if (subscriptionMetricCreate == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'subscriptionMetricCreate' when calling SubscriptionMetricsService->PostSubscriptionsMetrics");
            }
            ...
            localVarRequestOptions.HeaderParameters.Add("Space", PostFinanceCheckout.Client.ClientUtils.ParameterToString(space)); // header parameter
            localVarRequestOptions.Data = subscriptionMetricCreate;

            localVarRequestOptions.Operation = "SubscriptionMetricsService.PostSubscriptionsMetrics";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostSubscriptionsMetrics", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

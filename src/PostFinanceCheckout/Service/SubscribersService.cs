...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class SubscribersService : ISubscribersService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriberListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriberListResponse> GetSubscriptionsSubscribersWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Subscriber</returns>
        public PostFinanceCheckout.Client.ApiResponse<Subscriber> GetSubscriptionsSubscribersIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriberSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriberSearchResponse> GetSubscriptionsSubscribersSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Subscriber</returns>
        public PostFinanceCheckout.Client.ApiResponse<Subscriber> PatchSubscriptionsSubscribersIdWithHttpInfo(long id, long space, SubscriberUpdate subscriberUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Subscriber</returns>
        public PostFinanceCheckout.Client.ApiResponse<Subscriber> PostSubscriptionsSubscribersWithHttpInfo(long space, SubscriberCreate subscriberCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {

...
namespace PostFinanceCheckout.Service
{
    ...
    /// </summary>
    public interface ILegalOrganizationFormsServiceSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ILegalOrganizationFormsService : ILegalOrganizationFormsServiceSync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class LegalOrganizationFormsService : ILegalOrganizationFormsService
    {

        private PostFinanceCheckout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="LegalOrganizationFormsService"/> class
        /// using Configuration object
        /// </summary>
        /// <param name="configuration">An instance of Configuration</param>
        /// <returns></returns>
        public LegalOrganizationFormsService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public LegalOrganizationFormsService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<LegalOrganizationFormListResponse> localVarResponse = GetLegalOrganizationFormsWithHttpInfo(after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LegalOrganizationFormListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<LegalOrganizationFormListResponse> GetLegalOrganizationFormsWithHttpInfo(long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "LegalOrganizationFormsService.GetLegalOrganizationForms";
            ...
            {
                Exception _exception = this.ExceptionFactory("GetLegalOrganizationForms", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<LegalOrganizationForm> localVarResponse = GetLegalOrganizationFormsIdWithHttpInfo(id, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LegalOrganizationForm</returns>
        public PostFinanceCheckout.Client.ApiResponse<LegalOrganizationForm> GetLegalOrganizationFormsIdWithHttpInfo(long id, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "LegalOrganizationFormsService.GetLegalOrganizationFormsId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetLegalOrganizationFormsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<LegalOrganizationFormSearchResponse> localVarResponse = GetLegalOrganizationFormsSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LegalOrganizationFormSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<LegalOrganizationFormSearchResponse> GetLegalOrganizationFormsSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "LegalOrganizationFormsService.GetLegalOrganizationFormsSearch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetLegalOrganizationFormsSearch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class WebAppsService : IWebAppsService
    {
        ...
        /// <returns></returns>
        public WebAppsService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public WebAppsService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<bool> localVarResponse = GetWebAppsInstalledWithHttpInfo(space);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of bool</returns>
        public PostFinanceCheckout.Client.ApiResponse<bool> GetWebAppsInstalledWithHttpInfo(long space, int operationIndex = 0)
        {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<WebAppConfirmationResponse> localVarResponse = PostWebAppsConfirmCodeWithHttpInfo(code, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of WebAppConfirmationResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<WebAppConfirmationResponse> PostWebAppsConfirmCodeWithHttpInfo(string code, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'code' when calling WebAppsService->PostWebAppsConfirmCode");
            }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public PostFinanceCheckout.Client.ApiResponse<Object> PostWebAppsUninstallWithHttpInfo(long space, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();

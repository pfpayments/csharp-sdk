...
namespace PostFinanceCheckout.Service
{
    ...
    /// </summary>
    public interface ITokenVersionService : IApiAccessor
    {
        ...
        /// <param name="id">The id of a token for which you want to look up the current active token version.</param>
        /// <returns>TokenVersion</returns>
        TokenVersion ActiveVersion (long? spaceId, long? id);
        ...
        ApiResponse<TokenVersion> ActiveVersionWithHttpInfo (long? spaceId, long? id);
        /// <summary>
        /// Count
        /// </summary>
        /// <remarks>
        ...
        /// <returns>TokenVersion</returns>
        TokenVersion Read (long? spaceId, long? id);
        ...
        /// <param name="id">The id of the token version which should be returned.</param>
        /// <returns>ApiResponse of TokenVersion</returns>
        ApiResponse<TokenVersion> ReadWithHttpInfo (long? spaceId, long? id);
        /// <summary>
        /// Search
        /// </summary>
        /// <remarks>
        ...
        List<TokenVersion> Search (long? spaceId, EntityQuery query);
        ...
        ApiResponse<List<TokenVersion>> SearchWithHttpInfo (long? spaceId, EntityQuery query);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class TokenVersionService : ITokenVersionService
    {
        private PostFinanceCheckout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="TokenVersionService"/> class
        /// using Configuration object
        /// </summary>
        /// <param name="configuration">An instance of Configuration</param>
        /// <returns></returns>
        public TokenVersionService(PostFinanceCheckout.Client.Configuration configuration = null)
        {
        ...
        /// <param name="id">The id of a token for which you want to look up the current active token version.</param>
        /// <returns>TokenVersion</returns>
        public TokenVersion ActiveVersion (long? spaceId, long? id)
        {
             ApiResponse<TokenVersion> localVarResponse = ActiveVersionWithHttpInfo(spaceId, id);
        ...
        /// <param name="id">The id of a token for which you want to look up the current active token version.</param>
        /// <returns>ApiResponse of TokenVersion</returns>
        public ApiResponse< TokenVersion > ActiveVersionWithHttpInfo (long? spaceId, long? id)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
                throw new ApiException(400, "Missing required parameter 'spaceId' when calling TokenVersionService->ActiveVersion");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling TokenVersionService->ActiveVersion");

            var localVarPath = "/token-version/active-version";
            ...
            {
                Exception exception = ExceptionFactory("ActiveVersion", localVarResponse);
        ...
        public ApiResponse< long? > CountWithHttpInfo (long? spaceId, EntityQueryFilter filter = null)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
                throw new ApiException(400, "Missing required parameter 'spaceId' when calling TokenVersionService->Count");

            var localVarPath = "/token-version/count";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="id">The id of the token version which should be returned.</param>
        /// <returns>TokenVersion</returns>
        public TokenVersion Read (long? spaceId, long? id)
        {
             ApiResponse<TokenVersion> localVarResponse = ReadWithHttpInfo(spaceId, id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the token version which should be returned.</param>
        /// <returns>ApiResponse of TokenVersion</returns>
        public ApiResponse< TokenVersion > ReadWithHttpInfo (long? spaceId, long? id)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
        ...
        /// <param name="query">The query restricts the token versions which are returned by the search.</param>
        /// <returns>List&lt;TokenVersion&gt;</returns>
        public List<TokenVersion> Search (long? spaceId, EntityQuery query)
        {
             ApiResponse<List<TokenVersion>> localVarResponse = SearchWithHttpInfo(spaceId, query);
             return localVarResponse.Data;
        }
        ...
        /// <param name="query">The query restricts the token versions which are returned by the search.</param>
        /// <returns>ApiResponse of List&lt;TokenVersion&gt;</returns>
        public ApiResponse< List<TokenVersion> > SearchWithHttpInfo (long? spaceId, EntityQuery query)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)

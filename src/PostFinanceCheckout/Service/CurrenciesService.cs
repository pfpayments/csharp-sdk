...
namespace PostFinanceCheckout.Service
{
    ...
    /// </summary>
    public interface ICurrenciesServiceSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RestCurrency</returns>
        RestCurrency GetCurrenciesCode(string code, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICurrenciesService : ICurrenciesServiceSync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CurrenciesService : ICurrenciesService
    {
        ...
        /// <returns></returns>
        public CurrenciesService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public CurrenciesService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        public PostFinanceCheckout.Client.ApiResponse<CurrencyListResponse> GetCurrenciesWithHttpInfo(List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "CurrenciesService.GetCurrencies";
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RestCurrency</returns>
        public RestCurrency GetCurrenciesCode(string code, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.ApiResponse<RestCurrency> localVarResponse = GetCurrenciesCodeWithHttpInfo(code);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RestCurrency</returns>
        public PostFinanceCheckout.Client.ApiResponse<RestCurrency> GetCurrenciesCodeWithHttpInfo(string code, int operationIndex = 0)
        {
            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'code' when calling CurrenciesService->GetCurrenciesCode");
            }
            ...
            localVarRequestOptions.Operation = "CurrenciesService.GetCurrenciesCode";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetCurrenciesCode", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public PostFinanceCheckout.Client.ApiResponse<CurrencySearchResponse> GetCurrenciesSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "CurrenciesService.GetCurrenciesSearch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetCurrenciesSearch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

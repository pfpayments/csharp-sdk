...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class SubscriptionAffiliatesService : ISubscriptionAffiliatesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionAffiliateListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionAffiliateListResponse> GetSubscriptionsAffiliatesWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionAffiliate</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionAffiliate> GetSubscriptionsAffiliatesIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionAffiliateSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionAffiliateSearchResponse> GetSubscriptionsAffiliatesSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionAffiliate</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionAffiliate> PatchSubscriptionsAffiliatesIdWithHttpInfo(long id, long space, SubscriptionAffiliateUpdate subscriptionAffiliateUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionAffiliate</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionAffiliate> PostSubscriptionsAffiliatesWithHttpInfo(long space, SubscriptionAffiliateCreate subscriptionAffiliateCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {

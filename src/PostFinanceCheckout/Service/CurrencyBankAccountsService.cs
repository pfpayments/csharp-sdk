...
namespace PostFinanceCheckout.Service
{
    ...
    /// </summary>
    public interface ICurrencyBankAccountsServiceSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICurrencyBankAccountsService : ICurrencyBankAccountsServiceSync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CurrencyBankAccountsService : ICurrencyBankAccountsService
    {

        private PostFinanceCheckout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CurrencyBankAccountsService"/> class
        /// using Configuration object
        /// </summary>
        /// <param name="configuration">An instance of Configuration</param>
        /// <returns></returns>
        public CurrencyBankAccountsService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public CurrencyBankAccountsService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<CurrencyBankAccountListResponse> localVarResponse = GetPaymentCurrencyBankAccountsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyBankAccountListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<CurrencyBankAccountListResponse> GetPaymentCurrencyBankAccountsWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "CurrencyBankAccountsService.GetPaymentCurrencyBankAccounts";
            ...
            {
                Exception _exception = this.ExceptionFactory("GetPaymentCurrencyBankAccounts", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<CurrencyBankAccount> localVarResponse = GetPaymentCurrencyBankAccountsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyBankAccount</returns>
        public PostFinanceCheckout.Client.ApiResponse<CurrencyBankAccount> GetPaymentCurrencyBankAccountsIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "CurrencyBankAccountsService.GetPaymentCurrencyBankAccountsId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetPaymentCurrencyBankAccountsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<CurrencyBankAccountSearchResponse> localVarResponse = GetPaymentCurrencyBankAccountsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyBankAccountSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<CurrencyBankAccountSearchResponse> GetPaymentCurrencyBankAccountsSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "CurrencyBankAccountsService.GetPaymentCurrencyBankAccountsSearch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetPaymentCurrencyBankAccountsSearch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

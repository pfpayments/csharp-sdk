...
namespace PostFinanceCheckout.Service
{
    ...
    public partial class CurrencyBankAccountsService : ICurrencyBankAccountsService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyBankAccountListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<CurrencyBankAccountListResponse> GetPaymentCurrencyBankAccountsWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyBankAccount</returns>
        public PostFinanceCheckout.Client.ApiResponse<CurrencyBankAccount> GetPaymentCurrencyBankAccountsIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyBankAccountSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<CurrencyBankAccountSearchResponse> GetPaymentCurrencyBankAccountsSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();

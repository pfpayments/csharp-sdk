...
namespace PostFinanceCheckout.Service
{
    ...
    /// </summary>
    public interface ISubscriptionProductsServiceSync : IApiAccessor
    {
        ...
        /// <param name="id"></param>
        /// <param name="space">Specifies the ID of the space the operation should be executed in.</param>
        /// <param name="subscriptionProductActive"></param>
        /// <param name="expand"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>SubscriptionProduct</returns>
        ...
        /// <exception cref="PostFinanceCheckout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="space">Specifies the ID of the space the operation should be executed in.</param>
        /// <param name="subscriptionProductCreate"></param>
        /// <param name="expand"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>SubscriptionProduct</returns>
        ...
        /// <param name="id"></param>
        /// <param name="space">Specifies the ID of the space the operation should be executed in.</param>
        /// <param name="subscriptionProductRetirementRequest"></param>
        /// <param name="expand"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISubscriptionProductsService : ISubscriptionProductsServiceSync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SubscriptionProductsService : ISubscriptionProductsService
    {

        private PostFinanceCheckout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionProductsService"/> class
        /// using Configuration object
        /// </summary>
        /// <param name="configuration">An instance of Configuration</param>
        /// <returns></returns>
        public SubscriptionProductsService(PostFinanceCheckout.Client.Configuration configuration)
        {
        ...
        public SubscriptionProductsService(PostFinanceCheckout.Client.ISynchronousClient client, PostFinanceCheckout.Client.IReadableConfiguration configuration)
        {
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<ProductListResponse> localVarResponse = GetSubscriptionsProductsWithHttpInfo(space, after, before, expand, limit, order);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductListResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductListResponse> GetSubscriptionsProductsWithHttpInfo(long space, long? after = default(long?), long? before = default(long?), List<string>? expand = default(List<string>?), int? limit = default(int?), SortingOrder? order = default(SortingOrder?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SubscriptionProductsService.GetSubscriptionsProducts";
            ...
            {
                Exception _exception = this.ExceptionFactory("GetSubscriptionsProducts", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SubscriptionProduct> localVarResponse = GetSubscriptionsProductsIdWithHttpInfo(id, space, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionProduct</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionProduct> GetSubscriptionsProductsIdWithHttpInfo(long id, long space, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "SubscriptionProductsService.GetSubscriptionsProductsId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetSubscriptionsProductsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<ProductSearchResponse> localVarResponse = GetSubscriptionsProductsSearchWithHttpInfo(space, expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductSearchResponse</returns>
        public PostFinanceCheckout.Client.ApiResponse<ProductSearchResponse> GetSubscriptionsProductsSearchWithHttpInfo(long space, List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            PostFinanceCheckout.Client.RequestOptions localVarRequestOptions = new PostFinanceCheckout.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "SubscriptionProductsService.GetSubscriptionsProductsSearch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetSubscriptionsProductsSearch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SubscriptionProduct> localVarResponse = PatchSubscriptionsProductsIdWithHttpInfo(id, space, subscriptionProductActive, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionProduct</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionProduct> PatchSubscriptionsProductsIdWithHttpInfo(long id, long space, SubscriptionProductActive subscriptionProductActive, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'subscriptionProductActive' is set
            if (subscriptionProductActive == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'subscriptionProductActive' when calling SubscriptionProductsService->PatchSubscriptionsProductsId");
            }
            ...
            localVarRequestOptions.HeaderParameters.Add("Space", PostFinanceCheckout.Client.ClientUtils.ParameterToString(space)); // header parameter
            localVarRequestOptions.Data = subscriptionProductActive;

            localVarRequestOptions.Operation = "SubscriptionProductsService.PatchSubscriptionsProductsId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PatchSubscriptionsProductsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SubscriptionProduct> localVarResponse = PostSubscriptionsProductsWithHttpInfo(space, subscriptionProductCreate, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionProduct</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionProduct> PostSubscriptionsProductsWithHttpInfo(long space, SubscriptionProductCreate subscriptionProductCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'subscriptionProductCreate' is set
            if (subscriptionProductCreate == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'subscriptionProductCreate' when calling SubscriptionProductsService->PostSubscriptionsProducts");
            }
            ...
            localVarRequestOptions.HeaderParameters.Add("Space", PostFinanceCheckout.Client.ClientUtils.ParameterToString(space)); // header parameter
            localVarRequestOptions.Data = subscriptionProductCreate;

            localVarRequestOptions.Operation = "SubscriptionProductsService.PostSubscriptionsProducts";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostSubscriptionsProducts", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            PostFinanceCheckout.Client.ApiResponse<SubscriptionProductRetirement> localVarResponse = PostSubscriptionsProductsIdRetireWithHttpInfo(id, space, subscriptionProductRetirementRequest, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SubscriptionProductRetirement</returns>
        public PostFinanceCheckout.Client.ApiResponse<SubscriptionProductRetirement> PostSubscriptionsProductsIdRetireWithHttpInfo(long id, long space, SubscriptionProductRetirementRequest subscriptionProductRetirementRequest, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'subscriptionProductRetirementRequest' is set
            if (subscriptionProductRetirementRequest == null)
            {
                throw new PostFinanceCheckout.Client.ApiException(400, "Missing required parameter 'subscriptionProductRetirementRequest' when calling SubscriptionProductsService->PostSubscriptionsProductsIdRetire");
            }
            ...
            localVarRequestOptions.HeaderParameters.Add("Space", PostFinanceCheckout.Client.ClientUtils.ParameterToString(space)); // header parameter
            localVarRequestOptions.Data = subscriptionProductRetirementRequest;

            localVarRequestOptions.Operation = "SubscriptionProductsService.PostSubscriptionsProductsIdRetire";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostSubscriptionsProductsIdRetire", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }

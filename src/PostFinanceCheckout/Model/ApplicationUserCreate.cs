...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationUser.Create")]
    public partial class ApplicationUserCreate : IValidatableObject
    {
        ...
        [DataMember(Name = "primaryAccount", IsRequired = true, EmitDefaultValue = true)]

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Webhook_URL_Search_Response")]
    public partial class WebhookURLSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookURLSearchResponse" /> class.
        /// </summary>
        ...
        public List<WebhookUrl> Data { get; private set; }

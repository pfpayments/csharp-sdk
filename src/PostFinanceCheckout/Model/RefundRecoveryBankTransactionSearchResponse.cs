...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Refund_Recovery_Bank_Transaction_Search_Response")]
    public partial class RefundRecoveryBankTransactionSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundRecoveryBankTransactionSearchResponse" /> class.
        /// </summary>
        ...
        public List<RefundRecoveryBankTransaction> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Human_User_Search_Response")]
    public partial class HumanUserSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HumanUserSearchResponse" /> class.
        /// </summary>
        ...
        public List<HumanUser> Data { get; private set; }

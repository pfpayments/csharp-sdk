...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RefundBankTransaction")]
    public partial class RefundBankTransaction : IValidatableObject
    {
        /// <summary>
        ...
        public RefundBankTransaction(BankTransaction bankTransaction = default(BankTransaction), Refund refund = default(Refund))
        {

...
namespace PostFinanceCheckout.Model
{
    ...
    public partial class AbstractCustomerActive : IValidatableObject
    {
        ...
        public AbstractCustomerActive(Dictionary<string, string> metaData = default, string emailAddress = default, string familyName = default, string givenName = default, string preferredCurrency = default, string customerId = default, string language = default)
        {

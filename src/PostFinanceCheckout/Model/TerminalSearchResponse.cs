...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Terminal_Search_Response")]
    public partial class TerminalSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TerminalSearchResponse" /> class.
        /// </summary>
        ...
        public List<PaymentTerminal> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "User_Space_Role_List_Response")]
    public partial class UserSpaceRoleListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserSpaceRoleListResponse" /> class.
        /// </summary>
        ...
        public List<UserSpaceRole> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SpaceView :  IEquatable<SpaceView>
    {
        /// <summary>
        /// Gets or Sets State
        /// </summary>
        ...
        {
            return this.Equals(input as SpaceView);
        }

        /// <summary>
        /// Returns true if SpaceView instances are equal
        /// </summary>
        /// <param name="input">Instance of SpaceView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpaceView input)
        {
            if (input == null)
                return false;

...
namespace PostFinanceCheckout.Model
{
    ...
    /// WebhookUrlCreate
    /// </summary>
    [DataContract(Name = "WebhookUrl.Create")]
    public partial class WebhookUrlCreate : IValidatableObject
    {
        ...
        public WebhookUrlCreate(string name = default(string), CreationEntityState? state = default(CreationEntityState?), string url = default(string))
        {
            this.Name = name;
            this.State = state;
            this.Url = url;

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Subscription_Period_Bill_Search_Response")]
    public partial class SubscriptionPeriodBillSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionPeriodBillSearchResponse" /> class.
        /// </summary>
        ...
        public List<SubscriptionPeriodBill> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CardholderAuthentication.Create")]
    public partial class CardholderAuthenticationCreate : IValidatableObject
    {

        /// <summary>
        /// Gets or Sets AuthenticationResponse
        /// </summary>
        [DataMember(Name = "authenticationResponse", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// Initializes a new instance of the <see cref="CardholderAuthenticationCreate" /> class.
        /// </summary>
        /// <param name="authenticationIdentifier">The identifier (e.g., XID or DSTransactionID) assigned by the authentication system for tracking and verification..</param>

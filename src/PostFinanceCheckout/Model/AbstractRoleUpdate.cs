...
namespace PostFinanceCheckout.Model
{
    ...
    /// AbstractRoleUpdate
    /// </summary>
    [DataContract(Name = "Abstract.Role.Update")]
    public partial class AbstractRoleUpdate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AbstractRoleUpdate" /> class.
        /// </summary>

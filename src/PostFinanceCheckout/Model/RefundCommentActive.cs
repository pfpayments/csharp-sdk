...
namespace PostFinanceCheckout.Model
{
    ...
    /// RefundCommentActive
    /// </summary>
    [DataContract(Name = "RefundComment.Active")]
    public partial class RefundCommentActive : IValidatableObject
    {
        /// <summary>
        ...
        public RefundCommentActive(string content = default(string), int varVersion = default(int))
        {

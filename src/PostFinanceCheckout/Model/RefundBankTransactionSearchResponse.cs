...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Refund_Bank_Transaction_Search_Response")]
    public partial class RefundBankTransactionSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundBankTransactionSearchResponse" /> class.
        /// </summary>
        ...
        public List<RefundBankTransaction> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Language_Search_Response")]
    public partial class LanguageSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LanguageSearchResponse" /> class.
        /// </summary>
        ...
        public List<RestLanguage> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// BankAccountType
    /// </summary>
    [DataContract(Name = "BankAccountType")]
    public partial class BankAccountType : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns false as IdentifierName should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeIdentifierName()
        {
            return false;
        }
        /// <summary>

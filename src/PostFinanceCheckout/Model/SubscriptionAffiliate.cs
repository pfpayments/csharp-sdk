...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscriptionAffiliate")]
    public partial class SubscriptionAffiliate : IValidatableObject
    {
        ...
        public SubscriptionAffiliate(CreationEntityState? state = default(CreationEntityState?))
        {
            this.State = state;
        }

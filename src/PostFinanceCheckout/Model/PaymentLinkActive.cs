...
namespace PostFinanceCheckout.Model
{
    ...
    /// PaymentLinkActive
    /// </summary>
    [DataContract(Name = "PaymentLink.Active")]
    public partial class PaymentLinkActive : IValidatableObject
    {
        ...
        public PaymentLinkActive(PaymentLinkAddressHandlingMode? shippingAddressHandlingMode = default, List<string> allowedRedirectionDomains = default, string language = default, int varVersion = default, DateTime availableFrom = default, List<LineItemCreate> lineItems = default, DateTime availableUntil = default, string name = default, string currency = default, int maximalNumberOfTransactions = default, List<PaymentMethodConfiguration> allowedPaymentMethodConfigurations = default, long appliedSpaceView = default, PaymentLinkAddressHandlingMode? billingAddressHandlingMode = default, CreationEntityState? state = default)
        {

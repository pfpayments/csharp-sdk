...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentTerminalConfiguration")]
    public partial class PaymentTerminalConfiguration : IValidatableObject
    {
        ...
        public PaymentTerminalConfigurationState? State { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentTerminalConfiguration" /> class.
        /// </summary>
        /// <param name="state">state.</param>
        /// <param name="type">type.</param>
        public PaymentTerminalConfiguration(PaymentTerminalConfigurationState? state = default(PaymentTerminalConfigurationState?), PaymentTerminalType type = default(PaymentTerminalType))
        {
            this.State = state;
            this.Type = type;
        }

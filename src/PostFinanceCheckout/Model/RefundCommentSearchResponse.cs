...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Refund_Comment_Search_Response")]
    public partial class RefundCommentSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundCommentSearchResponse" /> class.
        /// </summary>
        ...
        public List<RefundComment> Data { get; private set; }

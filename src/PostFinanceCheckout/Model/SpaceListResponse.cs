...
namespace PostFinanceCheckout.Model
{
    ...
    /// SpaceListResponse
    /// </summary>
    [DataContract(Name = "Space_List_Response")]
    public partial class SpaceListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpaceListResponse" /> class.
        /// </summary>

...
namespace PostFinanceCheckout.Model
{
    ...
    public partial class Token : IValidatableObject
    {
        ...
        /// <summary>
        /// Returns false as EnabledForOneClickPayment should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeEnabledForOneClickPayment()
        {
            return false;
        }
        /// <summary>
        ...
        /// <summary>
        /// Returns false as TokenReference should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeTokenReference()
        {
            return false;
        }
        /// <summary>

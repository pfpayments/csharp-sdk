...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Charge_Flow_Search_Response")]
    public partial class ChargeFlowSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargeFlowSearchResponse" /> class.
        /// </summary>
        ...
        public List<ChargeFlow> Data { get; private set; }

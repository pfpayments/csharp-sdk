...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaxClass :  IEquatable<TaxClass>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The name used to identify the tax class.</value>
        ...
        {
            return this.Equals(input as TaxClass);
        }

        /// <summary>
        /// Returns true if TaxClass instances are equal
        /// </summary>
        /// <param name="input">Instance of TaxClass to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaxClass input)
        {
            if (input == null)
                return false;

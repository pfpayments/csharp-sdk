...
namespace PostFinanceCheckout.Model
{
    ...
    /// MetricListResponse
    /// </summary>
    [DataContract(Name = "Metric_List_Response")]
    public partial class MetricListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricListResponse" /> class.
        /// </summary>

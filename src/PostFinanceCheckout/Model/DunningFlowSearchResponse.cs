...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Dunning_Flow_Search_Response")]
    public partial class DunningFlowSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DunningFlowSearchResponse" /> class.
        /// </summary>
        ...
        public List<DunningFlow> Data { get; private set; }

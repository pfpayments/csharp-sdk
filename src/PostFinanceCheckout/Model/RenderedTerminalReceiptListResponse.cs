...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Rendered_Terminal_Receipt_List_Response")]
    public partial class RenderedTerminalReceiptListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RenderedTerminalReceiptListResponse" /> class.
        /// </summary>
        ...
        public List<RenderedTerminalReceipt> Data { get; private set; }

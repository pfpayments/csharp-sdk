...
namespace PostFinanceCheckout.Model
{
    ...
    public partial class TenantDatabase :  IEquatable<TenantDatabase>
    {
        ...
        {
            return this.Equals(input as TenantDatabase);
        }

        /// <summary>
        /// Returns true if TenantDatabase instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantDatabase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantDatabase input)
        {
            if (input == null)
                return false;

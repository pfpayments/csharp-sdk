...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Token_Version_Search_Response")]
    public partial class TokenVersionSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenVersionSearchResponse" /> class.
        /// </summary>
        ...
        public List<TokenVersion> Data { get; private set; }

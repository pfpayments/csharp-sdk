...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Currency_Search_Response")]
    public partial class CurrencySearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrencySearchResponse" /> class.
        /// </summary>
        ...
        public List<RestCurrency> Data { get; private set; }

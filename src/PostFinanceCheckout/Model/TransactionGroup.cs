...
namespace PostFinanceCheckout.Model
{
    ...
    public partial class TransactionGroup :  IEquatable<TransactionGroup>
    {
        ...
        {
            return this.Equals(input as TransactionGroup);
        }

        /// <summary>
        /// Returns true if TransactionGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionGroup input)
        {
            if (input == null)
                return false;

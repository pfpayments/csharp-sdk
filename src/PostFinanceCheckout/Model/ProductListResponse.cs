...
namespace PostFinanceCheckout.Model
{
    ...
    /// ProductListResponse
    /// </summary>
    [DataContract(Name = "Product_List_Response")]
    public partial class ProductListResponse : IValidatableObject
    {
        /// <summary>
        ...
        public List<SubscriptionProduct> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Bank_Account_Search_Response")]
    public partial class BankAccountSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BankAccountSearchResponse" /> class.
        /// </summary>
        ...
        public List<BankAccount> Data { get; private set; }

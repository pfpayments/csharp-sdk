...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionMetric :  IEquatable<SubscriptionMetric>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionMetric" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SubscriptionMetric);
        }

        /// <summary>
        /// Returns true if SubscriptionMetric instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionMetric to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionMetric input)
        {
            if (input == null)
                return false;

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Client_Platform_Information_Search_Response")]
    public partial class ClientPlatformInformationSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientPlatformInformationSearchResponse" /> class.
        /// </summary>
        ...
        public List<TransactionClientPlatformInformation> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    public partial class TransactionCreate : IValidatableObject
    {
        ...
        public TransactionCreate(string customerEmailAddress = default, string shippingMethod = default, string invoiceMerchantReference = default, string successUrl = default, string varTimeZone = default, string language = default, TokenizationMode? tokenizationMode = default, List<long> allowedPaymentMethodBrands = default, TransactionCompletionBehavior? completionBehavior = default, long token = default, List<LineItemCreate> lineItems = default, Dictionary<string, string> metaData = default, string customerId = default, AddressCreate shippingAddress = default, string currency = default, AddressCreate billingAddress = default, string merchantReference = default, List<long> allowedPaymentMethodConfigurations = default, string failedUrl = default, bool chargeRetryEnabled = default, bool emailsDisabled = default, ModelEnvironment? varEnvironment = default, TransactionEnvironmentSelectionStrategy? environmentSelectionStrategy = default, string deviceSessionIdentifier = default, bool autoConfirmationEnabled = default, long spaceViewId = default, CustomersPresence? customersPresence = default)
        {

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Payment_Connector_Configuration_Search_Response")]
    public partial class PaymentConnectorConfigurationSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentConnectorConfigurationSearchResponse" /> class.
        /// </summary>
        ...
        public List<PaymentConnectorConfiguration> Data { get; private set; }

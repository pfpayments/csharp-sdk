...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Metric_Search_Response")]
    public partial class MetricSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricSearchResponse" /> class.
        /// </summary>
        ...
        public List<SubscriptionMetric> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebhookIdentity :  IEquatable<WebhookIdentity>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The name used to identify the webhook identity.</value>
        ...
        {
            return this.Equals(input as WebhookIdentity);
        }

        /// <summary>
        /// Returns true if WebhookIdentity instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookIdentity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookIdentity input)
        {
            if (input == null)
                return false;

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Dunning_Case_Search_Response")]
    public partial class DunningCaseSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DunningCaseSearchResponse" /> class.
        /// </summary>
        ...
        public List<DunningCase> Data { get; private set; }

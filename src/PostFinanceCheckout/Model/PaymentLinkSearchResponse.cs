...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Payment_Link_Search_Response")]
    public partial class PaymentLinkSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentLinkSearchResponse" /> class.
        /// </summary>
        ...
        public List<PaymentLink> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscriptionMetricUsageReport")]
    public partial class SubscriptionMetricUsageReport : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns false as CreatedByUserId should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeCreatedByUserId()
        {
            return false;
        }
        /// <summary>
        ...
        /// <summary>
        /// Returns false as Metric should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>

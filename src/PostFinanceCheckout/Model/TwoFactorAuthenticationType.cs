...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TwoFactorAuthenticationType :  IEquatable<TwoFactorAuthenticationType>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TwoFactorAuthenticationType);
        }

        /// <summary>
        /// Returns true if TwoFactorAuthenticationType instances are equal
        /// </summary>
        /// <param name="input">Instance of TwoFactorAuthenticationType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TwoFactorAuthenticationType input)
        {
            if (input == null)
                return false;

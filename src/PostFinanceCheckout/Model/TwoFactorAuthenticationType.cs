...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TwoFactorAuthenticationType")]
    public partial class TwoFactorAuthenticationType : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns false as Feature should not be serialized given that it's read-only.
        /// </summary>

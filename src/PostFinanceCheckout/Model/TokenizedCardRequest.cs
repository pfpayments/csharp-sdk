...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TokenizedCardRequest")]
    public partial class TokenizedCardRequest : IValidatableObject
    {
        /// <summary>
        ...
        public TokenizedCardRequest(TokenizedCardDataCreate cardData = default(TokenizedCardDataCreate), long paymentMethodConfiguration = default(long))
        {
        ...
        public TokenizedCardDataCreate CardData { get; set; }

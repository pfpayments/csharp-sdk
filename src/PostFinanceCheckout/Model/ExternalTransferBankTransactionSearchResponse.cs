...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "External_Transfer_Bank_Transaction_Search_Response")]
    public partial class ExternalTransferBankTransactionSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalTransferBankTransactionSearchResponse" /> class.
        /// </summary>
        ...
        public List<ExternalTransferBankTransaction> Data { get; private set; }

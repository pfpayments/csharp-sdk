...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Document_Template_Type_Search_Response")]
    public partial class DocumentTemplateTypeSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentTemplateTypeSearchResponse" /> class.
        /// </summary>
        ...
        public List<DocumentTemplateType> Data { get; private set; }

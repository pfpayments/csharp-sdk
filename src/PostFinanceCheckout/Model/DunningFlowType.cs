...
namespace PostFinanceCheckout.Model
{
    ...
    /// DunningFlowType
    /// </summary>
    [DataContract(Name = "DunningFlowType")]
    public partial class DunningFlowType : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns false as SpecificCountry should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeSpecificCountry()
        {
            return false;
        }
        /// <summary>

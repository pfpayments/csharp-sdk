...
namespace PostFinanceCheckout.Model
{
    ...
    public partial class RefundRecoveryBankTransaction : TransactionAwareEntity,  IEquatable<RefundRecoveryBankTransaction>
    {
        ...
        {
            return this.Equals(input as RefundRecoveryBankTransaction);
        }

        /// <summary>
        /// Returns true if RefundRecoveryBankTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of RefundRecoveryBankTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundRecoveryBankTransaction input)
        {
            if (input == null)
                return false;

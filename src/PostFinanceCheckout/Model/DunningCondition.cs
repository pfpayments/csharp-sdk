...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DunningCondition :  IEquatable<DunningCondition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DunningCondition" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>The selected dunning condition type defines what settings are available to be configured on the condition in the next step.</value>
        ...
        {
            return this.Equals(input as DunningCondition);
        }

        /// <summary>
        /// Returns true if DunningCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of DunningCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DunningCondition input)
        {
            if (input == null)
                return false;

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DunningCondition")]
    public partial class DunningCondition : IValidatableObject
    {
        ...
        public DunningCondition(CreationEntityState? state = default(CreationEntityState?))
        {
            this.State = state;
        }

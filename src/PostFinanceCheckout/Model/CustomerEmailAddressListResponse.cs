...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Customer_Email_Address_List_Response")]
    public partial class CustomerEmailAddressListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerEmailAddressListResponse" /> class.
        /// </summary>
        ...
        public List<RestCustomerEmailAddress> Data { get; private set; }

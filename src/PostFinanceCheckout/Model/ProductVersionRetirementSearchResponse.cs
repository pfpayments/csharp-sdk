...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Product_Version_Retirement_Search_Response")]
    public partial class ProductVersionRetirementSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductVersionRetirementSearchResponse" /> class.
        /// </summary>
        ...
        public List<SubscriptionProductVersionRetirement> Data { get; private set; }

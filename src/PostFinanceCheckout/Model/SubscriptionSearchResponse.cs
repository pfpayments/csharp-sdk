...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Subscription_Search_Response")]
    public partial class SubscriptionSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionSearchResponse" /> class.
        /// </summary>
        ...
        public List<Subscription> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Manual_Task_Search_Response")]
    public partial class ManualTaskSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualTaskSearchResponse" /> class.
        /// </summary>
        ...
        public List<ManualTask> Data { get; private set; }

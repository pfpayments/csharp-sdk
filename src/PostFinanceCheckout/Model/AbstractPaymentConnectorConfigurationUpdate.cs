...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Abstract.PaymentConnectorConfiguration.Update")]
    public partial class AbstractPaymentConnectorConfigurationUpdate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AbstractPaymentConnectorConfigurationUpdate" /> class.
        /// </summary>

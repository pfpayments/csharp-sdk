...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscriptionAffiliate.Update")]
    public partial class SubscriptionAffiliateUpdate : IValidatableObject
    {
        ...
        public SubscriptionAffiliateUpdate(Dictionary<string, string> metaData = default(Dictionary<string, string>), string name = default(string), string language = default(string), CreationEntityState? state = default(CreationEntityState?), int varVersion = default(int))
        {

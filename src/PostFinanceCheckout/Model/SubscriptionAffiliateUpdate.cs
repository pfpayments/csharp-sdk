...
namespace PostFinanceCheckout.Model
{
    ...
    public partial class SubscriptionAffiliateUpdate : IValidatableObject
    {
        ...
        public SubscriptionAffiliateUpdate(Dictionary<string, string> metaData = default, string name = default, string language = default, CreationEntityState? state = default, int varVersion = default)
        {

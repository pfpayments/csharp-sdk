...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Abstract.Transaction.Pending")]
    public partial class AbstractTransactionPending : IValidatableObject
    {

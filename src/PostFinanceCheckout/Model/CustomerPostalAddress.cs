...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomerPostalAddress :  IEquatable<CustomerPostalAddress>
    {
        /// <summary>
        /// Gets or Sets Gender
        /// </summary>
        ...
        {
            return this.Equals(input as CustomerPostalAddress);
        }

        /// <summary>
        /// Returns true if CustomerPostalAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomerPostalAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomerPostalAddress input)
        {
            if (input == null)
                return false;

...
namespace PostFinanceCheckout.Model
{
    ...
    /// TokenListResponse
    /// </summary>
    [DataContract(Name = "Token_List_Response")]
    public partial class TokenListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenListResponse" /> class.
        /// </summary>

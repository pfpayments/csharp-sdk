...
namespace PostFinanceCheckout.Model
{
    ...
    /// TokenSearchResponse
    /// </summary>
    [DataContract(Name = "Token_Search_Response")]
    public partial class TokenSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenSearchResponse" /> class.
        /// </summary>
        ...
        public List<Token> Data { get; private set; }

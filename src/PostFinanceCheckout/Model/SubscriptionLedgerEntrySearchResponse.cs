...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Subscription_Ledger_Entry_Search_Response")]
    public partial class SubscriptionLedgerEntrySearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionLedgerEntrySearchResponse" /> class.
        /// </summary>
        ...
        public List<SubscriptionLedgerEntry> Data { get; private set; }

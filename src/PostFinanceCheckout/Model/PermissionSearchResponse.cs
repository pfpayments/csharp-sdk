...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Permission_Search_Response")]
    public partial class PermissionSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PermissionSearchResponse" /> class.
        /// </summary>
        ...
        public List<Permission> Data { get; private set; }

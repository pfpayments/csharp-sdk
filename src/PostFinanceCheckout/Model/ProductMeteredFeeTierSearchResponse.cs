...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Product_Metered_Fee_Tier_Search_Response")]
    public partial class ProductMeteredFeeTierSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductMeteredFeeTierSearchResponse" /> class.
        /// </summary>
        ...
        public List<ProductMeteredTierFee> Data { get; private set; }

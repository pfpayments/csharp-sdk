...
namespace PostFinanceCheckout.Model
{
    ...
    /// ProductSetupFee
    /// </summary>
    [DataContract(Name = "ProductSetupFee")]
    public partial class ProductSetupFee : IValidatableObject
    {
        ...
        /// <summary>
        /// Returns false as SetupFee should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeSetupFee()
        {
            return false;
        }
        /// <summary>
        ...
        /// <summary>
        /// Returns false as OnDowngradeCreditedAmount should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeOnDowngradeCreditedAmount()
        {
            return false;
        }
        /// <summary>
        ...
        /// <summary>
        /// Returns false as OnUpgradeCreditedAmount should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeOnUpgradeCreditedAmount()
        {
            return false;
        }
        /// <summary>

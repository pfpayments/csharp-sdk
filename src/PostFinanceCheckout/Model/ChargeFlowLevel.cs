...
namespace PostFinanceCheckout.Model
{
    ...
    /// ChargeFlowLevel
    /// </summary>
    [DataContract(Name = "ChargeFlowLevel")]
    public partial class ChargeFlowLevel : IValidatableObject
    {
        ...
        public Charge SynchronousCharge { get; set; }

        /// <summary>
        /// Gets or Sets VarConfiguration
        /// </summary>
        [DataMember(Name = "configuration", EmitDefaultValue = false)]
        public ChargeFlowLevelConfiguration VarConfiguration { get; set; }
        ...
        public Charge AsynchronousCharge { get; set; }
        ...
        public Charge TokenCharge { get; set; }

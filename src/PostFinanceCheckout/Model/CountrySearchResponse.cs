...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Country_Search_Response")]
    public partial class CountrySearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountrySearchResponse" /> class.
        /// </summary>
        ...
        public List<RestCountry> Data { get; private set; }

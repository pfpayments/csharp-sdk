...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InternalTransferBankTransaction")]
    public partial class InternalTransferBankTransaction : IValidatableObject
    {
        /// <summary>
        ...
        public BankTransaction SourceBankTransaction { get; set; }
        ...
        public BankTransaction TargetBankTransaction { get; set; }

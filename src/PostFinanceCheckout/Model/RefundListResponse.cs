...
namespace PostFinanceCheckout.Model
{
    ...
    /// RefundListResponse
    /// </summary>
    [DataContract(Name = "Refund_List_Response")]
    public partial class RefundListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundListResponse" /> class.
        /// </summary>

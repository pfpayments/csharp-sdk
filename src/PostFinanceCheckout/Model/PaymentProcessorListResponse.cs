...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Payment_Processor_List_Response")]
    public partial class PaymentProcessorListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProcessorListResponse" /> class.
        /// </summary>

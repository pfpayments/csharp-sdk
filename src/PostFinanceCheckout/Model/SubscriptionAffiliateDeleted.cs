...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscriptionAffiliate.Deleted")]
    public partial class SubscriptionAffiliateDeleted : IValidatableObject
    {
        ...
        public SubscriptionAffiliateDeleted(CreationEntityState? state = default(CreationEntityState?))
        {
            this.State = state;
        }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionAffiliateDeleted : SubscriptionAffiliate,  IEquatable<SubscriptionAffiliateDeleted>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SubscriptionAffiliateDeleted);
        }

        /// <summary>
        /// Returns true if SubscriptionAffiliateDeleted instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionAffiliateDeleted to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionAffiliateDeleted input)
        {
            if (input == null)
                return false;

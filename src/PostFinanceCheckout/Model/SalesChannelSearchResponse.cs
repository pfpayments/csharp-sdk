...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Sales_Channel_Search_Response")]
    public partial class SalesChannelSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesChannelSearchResponse" /> class.
        /// </summary>
        ...
        public List<SalesChannel> Data { get; private set; }

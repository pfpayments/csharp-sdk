...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Subscriber_Search_Response")]
    public partial class SubscriberSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriberSearchResponse" /> class.
        /// </summary>
        ...
        public List<Subscriber> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscriptionMetric.Active")]
    public partial class SubscriptionMetricActive : IValidatableObject
    {
        /// <summary>
        ...
        public SubscriptionMetricActive(Dictionary<string, string> name = default(Dictionary<string, string>), Dictionary<string, string> description = default(Dictionary<string, string>), int varVersion = default(int))
        {

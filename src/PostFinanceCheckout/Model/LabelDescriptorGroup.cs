...
namespace PostFinanceCheckout.Model
{
    ...
    public partial class LabelDescriptorGroup :  IEquatable<LabelDescriptorGroup>
    {
        ...
        {
            return this.Equals(input as LabelDescriptorGroup);
        }

        /// <summary>
        /// Returns true if LabelDescriptorGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of LabelDescriptorGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LabelDescriptorGroup input)
        {
            if (input == null)
                return false;

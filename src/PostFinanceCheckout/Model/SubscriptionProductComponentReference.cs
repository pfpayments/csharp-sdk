...
namespace PostFinanceCheckout.Model
{
    ...
    public partial class SubscriptionProductComponentReference :  IEquatable<SubscriptionProductComponentReference>
    {
        ...
        {
            return this.Equals(input as SubscriptionProductComponentReference);
        }

        /// <summary>
        /// Returns true if SubscriptionProductComponentReference instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionProductComponentReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionProductComponentReference input)
        {
            if (input == null)
                return false;

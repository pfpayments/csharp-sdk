...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Payment_Processor_Configuration_Search_Response")]
    public partial class PaymentProcessorConfigurationSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProcessorConfigurationSearchResponse" /> class.
        /// </summary>
        ...
        public List<PaymentProcessorConfiguration> Data { get; private set; }

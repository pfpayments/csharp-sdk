...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Charge_Attempt_Search_Response")]
    public partial class ChargeAttemptSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargeAttemptSearchResponse" /> class.
        /// </summary>
        ...
        public List<ChargeAttempt> Data { get; private set; }

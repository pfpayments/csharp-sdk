...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscriptionSuspension")]
    public partial class SubscriptionSuspension : IValidatableObject
    {
        ...
        /// <summary>
        /// Returns false as EffectiveEndDate should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeEffectiveEndDate()
        {
            return false;
        }
        /// <summary>
        ...
        /// <summary>
        /// Returns false as Note should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        ...
        /// <summary>
        /// Returns false as PeriodBill should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializePeriodBill()
        {
            return false;
        }
        /// <summary>
        ...
        /// <summary>
        /// Returns false as PlannedEndDate should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializePlannedEndDate()
        {
            return false;
        }
        /// <summary>

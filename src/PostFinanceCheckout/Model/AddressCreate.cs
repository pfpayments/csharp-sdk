...
using OpenAPIDateConverter = PostFinanceCheckout.Client.OpenAPIDateConverter;
...
namespace PostFinanceCheckout.Model
{
    ...
    /// AddressCreate
    /// </summary>
    [DataContract(Name = "Address.Create")]
    public partial class AddressCreate : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="country">The country is represented with a two-letter code (ISO 3166-1 alpha-2 standard) - for example, CH for Switzerland..</param>
        ...
        public AddressCreate(string country = default(string), string mobilePhoneNumber = default(string), Gender? gender = default(Gender?), string organizationName = default(string), string city = default(string), string commercialRegisterNumber = default(string), string socialSecurityNumber = default(string), string givenName = default(string), string postcode = default(string), long legalOrganizationForm = default(long), string salesTaxNumber = default(string), DateOnly dateOfBirth = default(DateOnly), string dependentLocality = default(string), string emailAddress = default(string), string phoneNumber = default(string), string sortingCode = default(string), string street = default(string), string familyName = default(string), string postalState = default(string), string salutation = default(string))
        {
        ...
        /// </summary>
        /// <value>The country is represented with a two-letter code (ISO 3166-1 alpha-2 standard) - for example, CH for Switzerland.</value>

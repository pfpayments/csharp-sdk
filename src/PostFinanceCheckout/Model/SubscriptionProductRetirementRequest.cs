...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscriptionProductRetirementRequest")]
    public partial class SubscriptionProductRetirementRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionProductRetirementRequest" /> class.
        /// </summary>
        /// <param name="respectTerminationPeriods">Whether the subscriptions&#39; termination periods should be respected..</param>
        /// <param name="targetProduct">The product to which the subscriptions with the retiring product are to be migrated. If none is defined, the subscriptions are terminated..</param>
        public SubscriptionProductRetirementRequest(bool respectTerminationPeriods = default(bool), long targetProduct = default(long))
        {

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Metric_Usage_Report_Search_Response")]
    public partial class MetricUsageReportSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricUsageReportSearchResponse" /> class.
        /// </summary>
        ...
        public List<SubscriptionMetricUsageReport> Data { get; private set; }

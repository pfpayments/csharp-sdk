...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Payment_Method_Configuration_Search_Response")]
    public partial class PaymentMethodConfigurationSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodConfigurationSearchResponse" /> class.
        /// </summary>
        ...
        public List<PaymentMethodConfiguration> Data { get; private set; }

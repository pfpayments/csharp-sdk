...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentProcessorConfiguration :  IEquatable<PaymentProcessorConfiguration>
    {
        /// <summary>
        /// Gets or Sets State
        /// </summary>
        ...
        {
            return this.Equals(input as PaymentProcessorConfiguration);
        }

        /// <summary>
        /// Returns true if PaymentProcessorConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentProcessorConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentProcessorConfiguration input)
        {
            if (input == null)
                return false;

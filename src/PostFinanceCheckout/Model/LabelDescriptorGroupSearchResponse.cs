...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Label_Descriptor_Group_Search_Response")]
    public partial class LabelDescriptorGroupSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelDescriptorGroupSearchResponse" /> class.
        /// </summary>
        ...
        public List<LabelDescriptorGroup> Data { get; private set; }

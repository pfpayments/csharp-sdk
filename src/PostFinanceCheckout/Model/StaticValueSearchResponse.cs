...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Static_Value_Search_Response")]
    public partial class StaticValueSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StaticValueSearchResponse" /> class.
        /// </summary>
        ...
        public List<StaticValue> Data { get; private set; }

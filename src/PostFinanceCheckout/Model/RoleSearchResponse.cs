...
namespace PostFinanceCheckout.Model
{
    ...
    /// RoleSearchResponse
    /// </summary>
    [DataContract(Name = "Role_Search_Response")]
    public partial class RoleSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoleSearchResponse" /> class.
        /// </summary>
        ...
        public List<Role> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Terminal_Transaction_Summary_Search_Response")]
    public partial class TerminalTransactionSummarySearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TerminalTransactionSummarySearchResponse" /> class.
        /// </summary>
        ...
        public List<PaymentTerminalTransactionSummary> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Product_Retirement_Search_Response")]
    public partial class ProductRetirementSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductRetirementSearchResponse" /> class.
        /// </summary>
        ...
        public List<SubscriptionProductRetirement> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// SpaceSearchResponse
    /// </summary>
    [DataContract(Name = "Space_Search_Response")]
    public partial class SpaceSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpaceSearchResponse" /> class.
        /// </summary>
        ...
        public List<Space> Data { get; private set; }

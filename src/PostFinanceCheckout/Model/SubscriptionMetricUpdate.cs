...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionMetricUpdate :  IEquatable<SubscriptionMetricUpdate>
    {
        /// <summary>
        ...
        public SubscriptionMetricUpdate(long? id, long? version)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for SubscriptionMetricUpdate and cannot be null");
            }
            this.Id = id;
            // to ensure "version" is required (not null)
            if (version == null)
            {
                throw new InvalidDataException("version is a required property for SubscriptionMetricUpdate and cannot be null");
            }
        ...
        {
            return this.Equals(input as SubscriptionMetricUpdate);
        }

        /// <summary>
        /// Returns true if SubscriptionMetricUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionMetricUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionMetricUpdate input)
        {
            if (input == null)
                return false;

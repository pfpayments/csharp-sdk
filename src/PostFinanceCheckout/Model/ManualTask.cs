...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManualTask")]
    public partial class ManualTask : IValidatableObject
    {
        ...
        /// <summary>
        /// Returns false as ContextEntityId should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeContextEntityId()
        {
            return false;
        }
        /// <summary>
        ...
        public List<ManualTaskAction> Actions { get; private set; }

        /// <summary>
        /// Returns false as Actions should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>

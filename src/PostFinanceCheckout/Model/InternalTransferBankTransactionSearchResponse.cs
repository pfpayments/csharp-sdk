...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Internal_Transfer_Bank_Transaction_Search_Response")]
    public partial class InternalTransferBankTransactionSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalTransferBankTransactionSearchResponse" /> class.
        /// </summary>
        ...
        public List<InternalTransferBankTransaction> Data { get; private set; }

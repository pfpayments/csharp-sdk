...
namespace PostFinanceCheckout.Model
{
    ...
    /// CardCryptogram
    /// </summary>
    [DataContract(Name = "CardCryptogram")]
    public partial class CardCryptogram : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns false as Eci should not be serialized given that it's read-only.
        /// </summary>

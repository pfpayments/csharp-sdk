...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShopifySubscriptionAddressCreate :  IEquatable<ShopifySubscriptionAddressCreate>
    {
        /// <summary>
        /// The gender.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShopifySubscriptionAddressCreate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ShopifySubscriptionAddressCreate);
        }

        /// <summary>
        /// Returns true if ShopifySubscriptionAddressCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of ShopifySubscriptionAddressCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShopifySubscriptionAddressCreate input)
        {
            if (input == null)
                return false;

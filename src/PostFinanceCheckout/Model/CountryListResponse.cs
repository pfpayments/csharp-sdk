...
namespace PostFinanceCheckout.Model
{
    ...
    /// CountryListResponse
    /// </summary>
    [DataContract(Name = "Country_List_Response")]
    public partial class CountryListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountryListResponse" /> class.
        /// </summary>

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Account_Search_Response")]
    public partial class AccountSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountSearchResponse" /> class.
        /// </summary>
        ...
        public List<Account> Data { get; private set; }

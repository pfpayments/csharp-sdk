...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Subscription_Affiliate_Search_Response")]
    public partial class SubscriptionAffiliateSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionAffiliateSearchResponse" /> class.
        /// </summary>
        ...
        public List<SubscriptionAffiliate> Data { get; private set; }

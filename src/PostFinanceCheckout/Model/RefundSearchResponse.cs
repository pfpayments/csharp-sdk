...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Refund_Search_Response")]
    public partial class RefundSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundSearchResponse" /> class.
        /// </summary>
        ...
        public List<Refund> Data { get; private set; }

...
namespace PostFinanceCheckout.Model
{
    ...
    /// WalletType
    /// </summary>
    [DataContract(Name = "WalletType")]
    public partial class WalletType : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns false as NavigationPath should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeNavigationPath()
        {
            return false;
        }
        /// <summary>

...
namespace PostFinanceCheckout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Condition_Type_Search_Response")]
    public partial class ConditionTypeSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConditionTypeSearchResponse" /> class.
        /// </summary>
        ...
        public List<ConditionType> Data { get; private set; }

...
namespace PostFinanceCheckout.Util
{
    /// <summary>
    ...
    public static class EncryptionUtil
    {
        ...
        /// </summary>
        /// <exception cref="PostFinanceCheckout.Client.PostFinanceCheckoutSdkException">Thrown when signature validation fails</exception>

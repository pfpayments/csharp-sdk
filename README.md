...
```
# Package Manager
Install-Package PostFinanceCheckout -Version 3.0.5
# .NET CLI
dotnet add package PostFinanceCheckout --version 3.0.5
# Paket CLI
paket add PostFinanceCheckout --version 3.0.5
# PackageReference
<PackageReference Include="PostFinanceCheckout" Version="3.0.5" />
```

...
```
# Package Manager
Install-Package PostFinanceCheckout -Version 2.0.7
# .NET CLI
dotnet add package PostFinanceCheckout --version 2.0.7
# Paket CLI
paket add PostFinanceCheckout --version 2.0.7
# PackageReference
<PackageReference Include="PostFinanceCheckout" Version="2.0.7" />
```

...
```
# Package Manager
Install-Package PostFinanceCheckout -Version 2.0.8
# .NET CLI
dotnet add package PostFinanceCheckout --version 2.0.8
# Paket CLI
paket add PostFinanceCheckout --version 2.0.8
# PackageReference
<PackageReference Include="PostFinanceCheckout" Version="2.0.8" />
```

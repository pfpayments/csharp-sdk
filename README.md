...
```
# Package Manager
Install-Package PostFinanceCheckout -Version 2.2.2
# .NET CLI
dotnet add package PostFinanceCheckout --version 2.2.2
# Paket CLI
paket add PostFinanceCheckout --version 2.2.2
# PackageReference
<PackageReference Include="PostFinanceCheckout" Version="2.2.2" />
```

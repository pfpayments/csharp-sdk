...
```
# Package Manager
Install-Package PostFinanceCheckout -Version 4.0.1
# .NET CLI
dotnet add package PostFinanceCheckout --version 4.0.1
# Paket CLI
paket add PostFinanceCheckout --version 4.0.1
# PackageReference
<PackageReference Include="PostFinanceCheckout" Version="4.0.1" />
```

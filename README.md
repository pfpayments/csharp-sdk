...
#### Package Manager
```shell
Install-Package PostFinanceCheckout -Version 1.0.0
```
#### .NET CLI
```shell
dotnet add package PostFinanceCheckout --version 1.0.0
```
#### Paket CLI
```shell
paket add PostFinanceCheckout --version 1.0.0
```
#### PackageReference
```
<PackageReference Include="PostFinanceCheckout" Version="1.0.0" />
```

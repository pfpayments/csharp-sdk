...
```
# Package Manager
Install-Package PostFinanceCheckout -Version 5.0.1
# .NET CLI
dotnet add package PostFinanceCheckout --version 5.0.1
# Paket CLI
paket add PostFinanceCheckout --version 5.0.1
# PackageReference
<PackageReference Include="PostFinanceCheckout" Version="5.0.1" />
```

...
```
# Package Manager
Install-Package PostFinanceCheckout -Version 5.0.0
# .NET CLI
dotnet add package PostFinanceCheckout --version 5.0.0
# Paket CLI
paket add PostFinanceCheckout --version 5.0.0
# PackageReference
<PackageReference Include="PostFinanceCheckout" Version="5.0.0" />
```

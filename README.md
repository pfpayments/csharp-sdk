...
```
# Package Manager
Install-Package PostFinanceCheckout -Version 4.0.4
# .NET CLI
dotnet add package PostFinanceCheckout --version 4.0.4
# Paket CLI
paket add PostFinanceCheckout --version 4.0.4
# PackageReference
<PackageReference Include="PostFinanceCheckout" Version="4.0.4" />
```

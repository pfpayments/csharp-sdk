[![Build Status](https://travis-ci.org/pfpayments/csharp-sdk.svg?branch=master)](https://travis-ci.org/pfpayments/csharp-sdk)
...
```
# Package Manager
Install-Package PostFinanceCheckout -Version 2.1.0
# .NET CLI
dotnet add package PostFinanceCheckout --version 2.1.0
# Paket CLI
paket add PostFinanceCheckout --version 2.1.0
# PackageReference
<PackageReference Include="PostFinanceCheckout" Version="2.1.0" />
```

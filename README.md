...
```
# Package Manager
Install-Package PostFinanceCheckout -Version 8.0.0
# .NET CLI
dotnet add package PostFinanceCheckout --version 8.0.0
# Paket CLI
paket add PostFinanceCheckout --version 8.0.0
# PackageReference
<PackageReference Include="PostFinanceCheckout" Version="8.0.0" />
```

...
```
# Package Manager
Install-Package PostFinanceCheckout -Version 8.1.0
# .NET CLI
dotnet add package PostFinanceCheckout --version 8.1.0
# Paket CLI
paket add PostFinanceCheckout --version 8.1.0
# PackageReference
<PackageReference Include="PostFinanceCheckout" Version="8.1.0" />
```
